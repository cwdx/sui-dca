...
export class GovernanceInstruction implements StructClass {
  ...
  readonly $typeName: typeof GovernanceInstruction.$typeName =
    GovernanceInstruction.$typeName;
  readonly $fullTypeName: `${string}::governance_instruction::GovernanceInstruction`;
  readonly $typeArgs: [];
  readonly $isPhantom: typeof GovernanceInstruction.$isPhantom =
    GovernanceInstruction.$isPhantom;
  ...
  static reified(): GovernanceInstructionReified {
    ...
    return {
      ...
      fromBcs: (data: Uint8Array) =>
        GovernanceInstruction.fromFields(reifiedBcs.parse(data)),
      bcs: reifiedBcs,
  ...
  private static cachedBcs: ReturnType<
    typeof GovernanceInstruction.instantiateBcs
  > | null = null;
