...
export class PythFeeRecipient implements StructClass {
  ...
  readonly $typeName: typeof PythFeeRecipient.$typeName =
    PythFeeRecipient.$typeName;
  readonly $fullTypeName: `${string}::set_fee_recipient::PythFeeRecipient`;
  readonly $typeArgs: [];
  readonly $isPhantom: typeof PythFeeRecipient.$isPhantom =
    PythFeeRecipient.$isPhantom;
  ...
  static reified(): PythFeeRecipientReified {
    ...
    return {
      ...
      fromBcs: (data: Uint8Array) =>
        PythFeeRecipient.fromFields(reifiedBcs.parse(data)),
      bcs: reifiedBcs,
  ...
  private static cachedBcs: ReturnType<
    typeof PythFeeRecipient.instantiateBcs
  > | null = null;
