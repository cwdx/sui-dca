...
export function isLatestOnly(type: string): boolean {
  ...
  return (
    type === `${getTypeOrigin("pyth", "state::LatestOnly")}::state::LatestOnly`
  );
}
...
export class LatestOnly implements StructClass {
  ...
  static readonly $typeName: `${string}::state::LatestOnly` = `${getTypeOrigin(
    "pyth",
    "state::LatestOnly",
  ...
  static reified(): LatestOnlyReified {
    ...
    return {
      ...
      fromBcs: (data: Uint8Array) =>
        LatestOnly.fromFields(reifiedBcs.parse(data)),
      bcs: reifiedBcs,
  ...
  private static cachedBcs: ReturnType<
    typeof LatestOnly.instantiateBcs
  > | null = null;
...
export class State implements StructClass {
  ...
  static readonly $typeName: `${string}::state::State` = `${getTypeOrigin(
    "pyth",
    "state::State",
  ...
  private static cachedBcs: ReturnType<typeof State.instantiateBcs> | null =
    null;
...
export function isCurrentDigest(type: string): boolean {
  ...
  return (
    type ===
    `${getTypeOrigin("pyth", "state::CurrentDigest")}::state::CurrentDigest`
  );
}
...
export class CurrentDigest implements StructClass {
  ...
  readonly $typeArgs: [];
  readonly $isPhantom: typeof CurrentDigest.$isPhantom =
    CurrentDigest.$isPhantom;
  ...
  static reified(): CurrentDigestReified {
    ...
    return {
      ...
      fromBcs: (data: Uint8Array) =>
        CurrentDigest.fromFields(reifiedBcs.parse(data)),
      bcs: reifiedBcs,
  ...
  private static cachedBcs: ReturnType<
    typeof CurrentDigest.instantiateBcs
  > | null = null;
