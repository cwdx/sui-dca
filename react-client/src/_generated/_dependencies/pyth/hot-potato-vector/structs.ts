...
export class HotPotatoVector<T extends TypeArgument> implements StructClass {
  ...
  readonly $typeName: typeof HotPotatoVector.$typeName =
    HotPotatoVector.$typeName;
  readonly $fullTypeName: `${string}::hot_potato_vector::HotPotatoVector<${ToTypeStr<T>}>`;
  readonly $typeArgs: [ToTypeStr<T>];
  readonly $isPhantom: typeof HotPotatoVector.$isPhantom =
    HotPotatoVector.$isPhantom;
  ...
  static reified<T extends Reified<TypeArgument, any>>(
    ...
    return {
      ...
      fromBcs: (data: Uint8Array) =>
        HotPotatoVector.fromFields(T, reifiedBcs.parse(data)),
      bcs: reifiedBcs,
  ...
  private static cachedBcs: ReturnType<
    typeof HotPotatoVector.instantiateBcs
  > | null = null;
