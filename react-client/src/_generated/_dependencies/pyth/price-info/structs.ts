...
export class PriceInfoObject implements StructClass {
  ...
  readonly $typeName: typeof PriceInfoObject.$typeName =
    PriceInfoObject.$typeName;
  readonly $fullTypeName: `${string}::price_info::PriceInfoObject`;
  readonly $typeArgs: [];
  readonly $isPhantom: typeof PriceInfoObject.$isPhantom =
  ...
  static reified(): PriceInfoObjectReified {
    ...
    return {
      ...
      fromBcs: (data: Uint8Array) =>
        PriceInfoObject.fromFields(reifiedBcs.parse(data)),
      bcs: reifiedBcs,
  ...
  private static cachedBcs: ReturnType<
    typeof PriceInfoObject.instantiateBcs
  > | null = null;
...
export function isPriceInfo(type: string): boolean {
  ...
  return (
    type ===
    `${getTypeOrigin("pyth", "price_info::PriceInfo")}::price_info::PriceInfo`
  );
}
...
export class PriceInfo implements StructClass {
  ...
  static reified(): PriceInfoReified {
    ...
    return {
      ...
      fromBcs: (data: Uint8Array) =>
        PriceInfo.fromFields(reifiedBcs.parse(data)),
      bcs: reifiedBcs,
  ...
  private static cachedBcs: ReturnType<typeof PriceInfo.instantiateBcs> | null =
    null;
