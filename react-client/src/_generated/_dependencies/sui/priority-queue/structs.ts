...
export class PriorityQueue<T extends TypeArgument> implements StructClass {
  ...
  readonly $isPhantom: typeof PriorityQueue.$isPhantom =
    PriorityQueue.$isPhantom;
  ...
  static reified<T extends Reified<TypeArgument, any>>(
    ...
    return {
      ...
      fromBcs: (data: Uint8Array) =>
        PriorityQueue.fromFields(T, reifiedBcs.parse(data)),
      bcs: reifiedBcs,
  ...
  private static cachedBcs: ReturnType<
    typeof PriorityQueue.instantiateBcs
  > | null = null;
...
export class Entry<T extends TypeArgument> implements StructClass {
  ...
  static readonly $typeName: `0x2::priority_queue::Entry` =
    `0x2::priority_queue::Entry` as const;
  static readonly $numTypeParams = 1;
  static readonly $isPhantom = [false] as const;
  ...
  static reified<T extends Reified<TypeArgument, any>>(
    ...
    return {
      ...
      fromBcs: (data: Uint8Array) =>
        Entry.fromFields(T, reifiedBcs.parse(data)),
      bcs: reifiedBcs,
