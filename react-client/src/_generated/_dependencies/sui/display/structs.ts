...
export interface DisplayFields<_T extends PhantomTypeArgument> {
  id: ToField<UID>;
  /**
...
export type DisplayJSONField<_T extends PhantomTypeArgument> = {
  id: string;
...
export interface DisplayCreatedFields<_T extends PhantomTypeArgument> {
  id: ToField<ID>;
}
...
export type DisplayCreatedJSONField<_T extends PhantomTypeArgument> = {
  id: string;
};
  ...
  implements StructClass
{
  ...
  readonly $typeName: typeof DisplayCreated.$typeName =
    DisplayCreated.$typeName;
  readonly $fullTypeName: `0x2::display::DisplayCreated<${PhantomToTypeStr<T>}>`;
  readonly $typeArgs: [PhantomToTypeStr<T>];
  readonly $isPhantom: typeof DisplayCreated.$isPhantom =
    DisplayCreated.$isPhantom;
...
export interface VersionUpdatedFields<_T extends PhantomTypeArgument> {
  id: ToField<ID>;
  version: ToField<"u16">;
  fields: ToField<VecMap<String, String>>;
}
...
export type VersionUpdatedJSONField<_T extends PhantomTypeArgument> = {
  id: string;
  version: number;
  fields: ToJSON<VecMap<String, String>>;
};
  ...
  implements StructClass
{
  ...
  readonly $typeName: typeof VersionUpdated.$typeName =
    VersionUpdated.$typeName;
  readonly $fullTypeName: `0x2::display::VersionUpdated<${PhantomToTypeStr<T>}>`;
  readonly $typeArgs: [PhantomToTypeStr<T>];
  readonly $isPhantom: typeof VersionUpdated.$isPhantom =
    VersionUpdated.$isPhantom;
