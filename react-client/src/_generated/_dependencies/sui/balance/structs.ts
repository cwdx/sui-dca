...
export interface SupplyFields<_T extends PhantomTypeArgument> {
  value: ToField<"u64">;
}
...
export type SupplyJSONField<_T extends PhantomTypeArgument> = {
  value: string;
};
...
export class Supply<T extends PhantomTypeArgument> implements StructClass {
  ...
  static reified<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      fromBcs: (data: Uint8Array) =>
        Supply.fromFields(T, reifiedBcs.parse(data)),
      bcs: reifiedBcs,
  ...
  private static cachedBcs: ReturnType<typeof Supply.instantiateBcs> | null =
    null;
...
export interface BalanceFields<_T extends PhantomTypeArgument> {
  value: ToField<"u64">;
}
...
export type BalanceJSONField<_T extends PhantomTypeArgument> = {
  value: string;
};
...
export class Balance<T extends PhantomTypeArgument> implements StructClass {
  ...
  static reified<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      fromBcs: (data: Uint8Array) =>
        Balance.fromFields(T, reifiedBcs.parse(data)),
      bcs: reifiedBcs,
  ...
  private static cachedBcs: ReturnType<typeof Balance.instantiateBcs> | null =
    null;
