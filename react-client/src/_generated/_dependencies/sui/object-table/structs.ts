...
export interface ObjectTableFields<
  _K extends PhantomTypeArgument,
  _V extends PhantomTypeArgument,
> {
...
export type ObjectTableJSONField<
  _K extends PhantomTypeArgument,
  _V extends PhantomTypeArgument,
> = {
  id: string;
...
> implements StructClass
{
  ...
  >(
    ...
    return {
      ...
      fromBcs: (data: Uint8Array) =>
        ObjectTable.fromFields([K, V], reifiedBcs.parse(data)),
      bcs: reifiedBcs,
  ...
  private static cachedBcs: ReturnType<
    typeof ObjectTable.instantiateBcs
  > | null = null;
