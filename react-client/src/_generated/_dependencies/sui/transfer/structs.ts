...
export interface ReceivingFields<_T extends PhantomTypeArgument> {
  id: ToField<ID>;
  version: ToField<"u64">;
}
...
export type ReceivingJSONField<_T extends PhantomTypeArgument> = {
  id: string;
  version: string;
};
...
export class Receiving<T extends PhantomTypeArgument> implements StructClass {
  ...
  static readonly $typeName: `0x2::transfer::Receiving` =
    `0x2::transfer::Receiving` as const;
  ...
  static reified<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      fromBcs: (data: Uint8Array) =>
        Receiving.fromFields(T, reifiedBcs.parse(data)),
      bcs: reifiedBcs,
  ...
  private static cachedBcs: ReturnType<typeof Receiving.instantiateBcs> | null =
    null;
