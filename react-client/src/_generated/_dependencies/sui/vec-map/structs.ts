  ...
  implements StructClass
{
  ...
  >(K: K, V: V): VecMapReified<ToTypeArgument<K>, ToTypeArgument<V>> {
    ...
    return {
      ...
      fromBcs: (data: Uint8Array) =>
        VecMap.fromFields([K, V], reifiedBcs.parse(data)),
      bcs: reifiedBcs,
  ...
  private static cachedBcs: ReturnType<typeof VecMap.instantiateBcs> | null =
    null;
  ...
  implements StructClass
{
  ...
  >(K: K, V: V): EntryReified<ToTypeArgument<K>, ToTypeArgument<V>> {
    ...
    return {
      ...
      fromBcs: (data: Uint8Array) =>
        Entry.fromFields([K, V], reifiedBcs.parse(data)),
      bcs: reifiedBcs,
