...
export class Referent<T extends TypeArgument> implements StructClass {
  ...
  static reified<T extends Reified<TypeArgument, any>>(
    ...
    return {
      ...
      fromBcs: (data: Uint8Array) =>
        Referent.fromFields(T, reifiedBcs.parse(data)),
      bcs: reifiedBcs,
  ...
  private static cachedBcs: ReturnType<typeof Referent.instantiateBcs> | null =
    null;
