...
export type EventStreamHeadReified = Reified<
  EventStreamHead,
  EventStreamHeadFields
>;
...
export class EventStreamHead implements StructClass {
  ...
  readonly $typeName: typeof EventStreamHead.$typeName =
    EventStreamHead.$typeName;
  readonly $fullTypeName: `0x2::accumulator_settlement::EventStreamHead`;
  readonly $typeArgs: [];
  readonly $isPhantom: typeof EventStreamHead.$isPhantom =
    EventStreamHead.$isPhantom;
  ...
  static reified(): EventStreamHeadReified {
    ...
    return {
      ...
      fromFields: (fields: Record<string, any>) =>
        EventStreamHead.fromFields(fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        EventStreamHead.fromFieldsWithTypes(item),
      fromBcs: (data: Uint8Array) =>
        EventStreamHead.fromFields(reifiedBcs.parse(data)),
      bcs: reifiedBcs,
      ...
      fromSuiParsedData: (content: SuiParsedData) =>
        EventStreamHead.fromSuiParsedData(content),
      fromSuiObjectData: (content: SuiObjectData) =>
        EventStreamHead.fromSuiObjectData(content),
      fetch: async (client: SupportedSuiClient, id: string) =>
        EventStreamHead.fetch(client, id),
  ...
  private static cachedBcs: ReturnType<
    typeof EventStreamHead.instantiateBcs
  > | null = null;
  ...
  static fromFieldsWithTypes(item: FieldsWithTypes): EventStreamHead {
    ...
    return EventStreamHead.reified().new({
      ...
      checkpointSeq: decodeFromFieldsWithTypes(
        "u64",
        item.fields.checkpoint_seq,
      ),
  ...
  static fromSuiParsedData(content: SuiParsedData): EventStreamHead {
    ...
    if (!isEventStreamHead(content.type)) {
      throw new Error(
        `object at ${(content.fields as any).id} is not a EventStreamHead object`,
      );
    }
  ...
  static fromSuiObjectData(data: SuiObjectData): EventStreamHead {
    if (data.bcs) {
      if (
        ...
        !isEventStreamHead(data.bcs.type)
      ) {
