...
export class CoinRegistry implements StructClass {
  ...
  static reified(): CoinRegistryReified {
    ...
    return {
      ...
      fromFields: (fields: Record<string, any>) =>
        CoinRegistry.fromFields(fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        CoinRegistry.fromFieldsWithTypes(item),
      fromBcs: (data: Uint8Array) =>
        CoinRegistry.fromFields(reifiedBcs.parse(data)),
      bcs: reifiedBcs,
      ...
      fromSuiParsedData: (content: SuiParsedData) =>
        CoinRegistry.fromSuiParsedData(content),
      fromSuiObjectData: (content: SuiObjectData) =>
        CoinRegistry.fromSuiObjectData(content),
      fetch: async (client: SupportedSuiClient, id: string) =>
        CoinRegistry.fetch(client, id),
  ...
  private static cachedBcs: ReturnType<
    typeof CoinRegistry.instantiateBcs
  > | null = null;
  ...
  static fromSuiParsedData(content: SuiParsedData): CoinRegistry {
    ...
    if (!isCoinRegistry(content.type)) {
      throw new Error(
        `object at ${(content.fields as any).id} is not a CoinRegistry object`,
      );
    }
...
export class ExtraField implements StructClass {
  ...
  static reified(): ExtraFieldReified {
    ...
    return {
      ...
      reifiedTypeArgs: [],
      fromFields: (fields: Record<string, any>) =>
        ExtraField.fromFields(fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        ExtraField.fromFieldsWithTypes(item),
      fromBcs: (data: Uint8Array) =>
        ExtraField.fromFields(reifiedBcs.parse(data)),
      bcs: reifiedBcs,
      fromJSONField: (field: any) => ExtraField.fromJSONField(field),
      fromJSON: (json: Record<string, any>) => ExtraField.fromJSON(json),
      fromSuiParsedData: (content: SuiParsedData) =>
        ExtraField.fromSuiParsedData(content),
      fromSuiObjectData: (content: SuiObjectData) =>
        ExtraField.fromSuiObjectData(content),
      fetch: async (client: SupportedSuiClient, id: string) =>
        ExtraField.fetch(client, id),
  ...
  private static cachedBcs: ReturnType<
    typeof ExtraField.instantiateBcs
  > | null = null;
  ...
  static fromSuiParsedData(content: SuiParsedData): ExtraField {
    ...
    if (!isExtraField(content.type)) {
      throw new Error(
        `object at ${(content.fields as any).id} is not a ExtraField object`,
      );
    }
...
export interface CurrencyKeyFields<_T extends PhantomTypeArgument> {
...
export type CurrencyKeyJSONField<_T extends PhantomTypeArgument> = {
  dummyField: boolean;
};
...
export class CurrencyKey<T extends PhantomTypeArgument> implements StructClass {
  ...
  static reified<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      reifiedTypeArgs: [T],
      fromFields: (fields: Record<string, any>) =>
        CurrencyKey.fromFields(T, fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        CurrencyKey.fromFieldsWithTypes(T, item),
      fromBcs: (data: Uint8Array) =>
        CurrencyKey.fromFields(T, reifiedBcs.parse(data)),
      bcs: reifiedBcs,
      fromJSONField: (field: any) => CurrencyKey.fromJSONField(T, field),
      fromJSON: (json: Record<string, any>) => CurrencyKey.fromJSON(T, json),
      fromSuiParsedData: (content: SuiParsedData) =>
        CurrencyKey.fromSuiParsedData(T, content),
      fromSuiObjectData: (content: SuiObjectData) =>
        CurrencyKey.fromSuiObjectData(T, content),
      fetch: async (client: SupportedSuiClient, id: string) =>
        CurrencyKey.fetch(client, T, id),
  ...
  private static cachedBcs: ReturnType<
    typeof CurrencyKey.instantiateBcs
  > | null = null;
  ...
  static fromSuiParsedData<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    if (!isCurrencyKey(content.type)) {
      throw new Error(
        `object at ${(content.fields as any).id} is not a CurrencyKey object`,
      );
    }
...
export type LegacyMetadataKeyReified = Reified<
  LegacyMetadataKey,
  LegacyMetadataKeyFields
>;
...
export class LegacyMetadataKey implements StructClass {
  ...
  readonly $typeName: typeof LegacyMetadataKey.$typeName =
    LegacyMetadataKey.$typeName;
  readonly $fullTypeName: `0x2::coin_registry::LegacyMetadataKey`;
  readonly $typeArgs: [];
  readonly $isPhantom: typeof LegacyMetadataKey.$isPhantom =
    LegacyMetadataKey.$isPhantom;
  ...
  static reified(): LegacyMetadataKeyReified {
    ...
    return {
      ...
      reifiedTypeArgs: [],
      fromFields: (fields: Record<string, any>) =>
        LegacyMetadataKey.fromFields(fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        LegacyMetadataKey.fromFieldsWithTypes(item),
      fromBcs: (data: Uint8Array) =>
        LegacyMetadataKey.fromFields(reifiedBcs.parse(data)),
      bcs: reifiedBcs,
      ...
      fromSuiParsedData: (content: SuiParsedData) =>
        LegacyMetadataKey.fromSuiParsedData(content),
      fromSuiObjectData: (content: SuiObjectData) =>
        LegacyMetadataKey.fromSuiObjectData(content),
      fetch: async (client: SupportedSuiClient, id: string) =>
        LegacyMetadataKey.fetch(client, id),
  ...
  private static cachedBcs: ReturnType<
    typeof LegacyMetadataKey.instantiateBcs
  > | null = null;
  ...
  static fromSuiParsedData(content: SuiParsedData): LegacyMetadataKey {
    ...
    if (!isLegacyMetadataKey(content.type)) {
      throw new Error(
        `object at ${(content.fields as any).id} is not a LegacyMetadataKey object`,
      );
    }
  ...
  static fromSuiObjectData(data: SuiObjectData): LegacyMetadataKey {
    if (data.bcs) {
      if (
        data.bcs.dataType !== "moveObject" ||
        !isLegacyMetadataKey(data.bcs.type)
      ) {
...
export interface MetadataCapFields<_T extends PhantomTypeArgument> {
  id: ToField<UID>;
}
...
export type MetadataCapJSONField<_T extends PhantomTypeArgument> = {
  id: string;
};
...
export class MetadataCap<T extends PhantomTypeArgument> implements StructClass {
  ...
  static reified<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      reifiedTypeArgs: [T],
      fromFields: (fields: Record<string, any>) =>
        MetadataCap.fromFields(T, fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        MetadataCap.fromFieldsWithTypes(T, item),
      fromBcs: (data: Uint8Array) =>
        MetadataCap.fromFields(T, reifiedBcs.parse(data)),
      bcs: reifiedBcs,
      fromJSONField: (field: any) => MetadataCap.fromJSONField(T, field),
      fromJSON: (json: Record<string, any>) => MetadataCap.fromJSON(T, json),
      fromSuiParsedData: (content: SuiParsedData) =>
        MetadataCap.fromSuiParsedData(T, content),
      fromSuiObjectData: (content: SuiObjectData) =>
        MetadataCap.fromSuiObjectData(T, content),
      fetch: async (client: SupportedSuiClient, id: string) =>
        MetadataCap.fetch(client, T, id),
  ...
  private static cachedBcs: ReturnType<
    typeof MetadataCap.instantiateBcs
  > | null = null;
  ...
  static fromSuiParsedData<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    if (!isMetadataCap(content.type)) {
      throw new Error(
        `object at ${(content.fields as any).id} is not a MetadataCap object`,
      );
    }
...
export interface BorrowFields<_T extends PhantomTypeArgument> {
  dummyField: ToField<"bool">;
}

export type BorrowReified<T extends PhantomTypeArgument> = Reified<
  Borrow<T>,
  BorrowFields<T>
>;

export type BorrowJSONField<_T extends PhantomTypeArgument> = {
  dummyField: boolean;
};
...
export class Borrow<T extends PhantomTypeArgument> implements StructClass {
  ...
  static readonly $typeName: `0x2::coin_registry::Borrow` =
    `0x2::coin_registry::Borrow` as const;
  static readonly $numTypeParams = 1;
  static readonly $isPhantom = [true] as const;
  ...
  static reified<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        Borrow.fromFieldsWithTypes(T, item),
      fromBcs: (data: Uint8Array) =>
        Borrow.fromFields(T, reifiedBcs.parse(data)),
      bcs: reifiedBcs,
      fromJSONField: (field: any) => Borrow.fromJSONField(T, field),
      fromJSON: (json: Record<string, any>) => Borrow.fromJSON(T, json),
      fromSuiParsedData: (content: SuiParsedData) =>
        Borrow.fromSuiParsedData(T, content),
      fromSuiObjectData: (content: SuiObjectData) =>
        Borrow.fromSuiObjectData(T, content),
      fetch: async (client: SupportedSuiClient, id: string) =>
        Borrow.fetch(client, T, id),
  ...
  private static cachedBcs: ReturnType<typeof Borrow.instantiateBcs> | null =
    null;
...
export type CurrencyReified<T extends PhantomTypeArgument> = Reified<
  Currency<T>,
  CurrencyFields<T>
>;
...
export class Currency<T extends PhantomTypeArgument> implements StructClass {
  ...
  static reified<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      reifiedTypeArgs: [T],
      fromFields: (fields: Record<string, any>) =>
        Currency.fromFields(T, fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        Currency.fromFieldsWithTypes(T, item),
      fromBcs: (data: Uint8Array) =>
        Currency.fromFields(T, reifiedBcs.parse(data)),
      bcs: reifiedBcs,
      fromJSONField: (field: any) => Currency.fromJSONField(T, field),
      fromJSON: (json: Record<string, any>) => Currency.fromJSON(T, json),
      fromSuiParsedData: (content: SuiParsedData) =>
        Currency.fromSuiParsedData(T, content),
      fromSuiObjectData: (content: SuiObjectData) =>
        Currency.fromSuiObjectData(T, content),
      fetch: async (client: SupportedSuiClient, id: string) =>
        Currency.fetch(client, T, id),
  ...
  private static cachedBcs: ReturnType<typeof Currency.instantiateBcs> | null =
    null;
  ...
  static fromFieldsWithTypes<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return Currency.reified(typeArg).new({
      ...
      regulated: decodeFromFieldsWithTypes(
        RegulatedState.reified(),
        item.fields.regulated,
      ),
  ...
  static fromJSONField<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return Currency.reified(typeArg).new({
      ...
      supply: decodeFromJSONField(
        Option.reified(SupplyState.reified(typeArg)),
        field.supply,
      ),
      regulated: decodeFromJSONField(RegulatedState.reified(), field.regulated),
      treasuryCapId: decodeFromJSONField(
        Option.reified(ID.reified()),
        field.treasuryCapId,
      ),
      metadataCapId: decodeFromJSONField(
        MetadataCapState.reified(),
        field.metadataCapId,
      ),
  ...
  static fromSuiParsedData<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    if (!isCurrency(content.type)) {
      throw new Error(
        `object at ${(content.fields as any).id} is not a Currency object`,
      );
    }
 ...
 * currencies).
 */
export class CurrencyInitializer<T extends PhantomTypeArgument>
  implements StructClass
{
  ...
  readonly $typeName: typeof CurrencyInitializer.$typeName =
    CurrencyInitializer.$typeName;
  readonly $fullTypeName: `0x2::coin_registry::CurrencyInitializer<${PhantomToTypeStr<T>}>`;
  readonly $typeArgs: [PhantomToTypeStr<T>];
  readonly $isPhantom: typeof CurrencyInitializer.$isPhantom =
    CurrencyInitializer.$isPhantom;
  ...
  private constructor(
    typeArgs: [PhantomToTypeStr<T>],
    fields: CurrencyInitializerFields<T>,
  ) {
    this.$fullTypeName = composeSuiType(
      CurrencyInitializer.$typeName,
      ...typeArgs,
  ...
  static reified<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      reifiedTypeArgs: [T],
      fromFields: (fields: Record<string, any>) =>
        CurrencyInitializer.fromFields(T, fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        CurrencyInitializer.fromFieldsWithTypes(T, item),
      fromBcs: (data: Uint8Array) =>
        CurrencyInitializer.fromFields(T, reifiedBcs.parse(data)),
      bcs: reifiedBcs,
      fromJSONField: (field: any) =>
        CurrencyInitializer.fromJSONField(T, field),
      fromJSON: (json: Record<string, any>) =>
        CurrencyInitializer.fromJSON(T, json),
      fromSuiParsedData: (content: SuiParsedData) =>
  ...
  private static cachedBcs: ReturnType<
    typeof CurrencyInitializer.instantiateBcs
  > | null = null;
  ...
  static fromFieldsWithTypes<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return CurrencyInitializer.reified(typeArg).new({
      currency: decodeFromFieldsWithTypes(
        Currency.reified(typeArg),
  ...
  static fromBcs<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return CurrencyInitializer.fromFields(
      typeArg,
      CurrencyInitializer.bcs.parse(data),
    );
  }
  ...
  static fromSuiParsedData<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    if (!isCurrencyInitializer(content.type)) {
      throw new Error(
        `object at ${(content.fields as any).id} is not a CurrencyInitializer object`,
      );
    }
  ...
  static fromSuiObjectData<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    if (data.bcs) {
      if (
        data.bcs.dataType !== "moveObject" ||
        !isCurrencyInitializer(data.bcs.type)
      ) {
      ...
      return CurrencyInitializer.fromBcs(
        typeArg,
...
export function isSupplyStateVariantName(
  variant: string,
): variant is SupplyStateVariantName {
...
export class SupplyState {
  ...
  static reified<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      reifiedTypeArgs: [T],
      fromFields: (fields: Record<string, any>) =>
        SupplyState.fromFields([T], fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        SupplyState.fromFieldsWithTypes([T], item),
      ...
      new: (
        ...
        switch (variant) {
          ...
          case "Unknown":
            return new SupplyStateUnknown(
              [extractType(T)],
              fields as SupplyStateUnknownFields,
            );
        }
      },
  ...
  private static cachedBcs: ReturnType<
    typeof SupplyState.instantiateBcs
  > | null = null;
  ...
  static fromFieldsWithTypes<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    const variant = (
      item as FieldsWithTypes & { variant: SupplyStateVariantName }
    ).variant;
...
export class SupplyStateFixed<T extends PhantomTypeArgument>
  implements EnumVariantClass
{
  __EnumVariantClass = true as const;

  static readonly $typeName: typeof SupplyState.$typeName =
    SupplyState.$typeName;
  static readonly $numTypeParams: typeof SupplyState.$numTypeParams =
    SupplyState.$numTypeParams;
  static readonly $isPhantom: typeof SupplyState.$isPhantom =
    SupplyState.$isPhantom;
  static readonly $variantName = "Fixed" as const;

  readonly $typeName: typeof SupplyStateFixed.$typeName =
    SupplyStateFixed.$typeName;
  ...
  readonly $variantName: typeof SupplyStateFixed.$variantName =
    SupplyStateFixed.$variantName;

  readonly 0: ToField<Supply<T>>;

  constructor(
    typeArgs: [PhantomToTypeStr<T>],
    fields: SupplyStateFixedFields<T>,
  ) {
    this.$fullTypeName = composeSuiType(
      SupplyState.$typeName,
      ...typeArgs,
  ...
  toJSONField(): SupplyStateFixedJSONField<T> {
    return {
      ...
      vec: [
        fieldToJSON<Supply<T>>(
          `${Supply.$typeName}<${this.$typeArgs[0]}>`,
          this[0],
        ),
      ],
    };
...
export class SupplyStateBurnOnly<T extends PhantomTypeArgument>
  implements EnumVariantClass
{
  __EnumVariantClass = true as const;
  ...
  readonly $typeName: typeof SupplyStateBurnOnly.$typeName =
    SupplyStateBurnOnly.$typeName;
  readonly $fullTypeName: `${typeof SupplyState.$typeName}<${PhantomToTypeStr<T>}>`;
  readonly $typeArgs: [PhantomToTypeStr<T>];
  readonly $isPhantom: typeof SupplyState.$isPhantom = SupplyState.$isPhantom;
  readonly $variantName: typeof SupplyStateBurnOnly.$variantName =
    SupplyStateBurnOnly.$variantName;

  readonly 0: ToField<Supply<T>>;

  constructor(
    typeArgs: [PhantomToTypeStr<T>],
    fields: SupplyStateBurnOnlyFields<T>,
  ) {
    this.$fullTypeName = composeSuiType(
      SupplyState.$typeName,
      ...typeArgs,
...
export type SupplyStateUnknownJSONField<_T extends PhantomTypeArgument> = {
  $kind: "Unknown";
};
...
export class SupplyStateUnknown<T extends PhantomTypeArgument>
  implements EnumVariantClass
{
  __EnumVariantClass = true as const;
  ...
  readonly $typeName: typeof SupplyStateUnknown.$typeName =
    SupplyStateUnknown.$typeName;
  readonly $fullTypeName: `${typeof SupplyState.$typeName}<${PhantomToTypeStr<T>}>`;
  readonly $typeArgs: [PhantomToTypeStr<T>];
  readonly $isPhantom: typeof SupplyState.$isPhantom = SupplyState.$isPhantom;
  readonly $variantName: typeof SupplyStateUnknown.$variantName =
    SupplyStateUnknown.$variantName;

  constructor(
    typeArgs: [PhantomToTypeStr<T>],
    _fields: SupplyStateUnknownFields,
  ) {
    this.$fullTypeName = composeSuiType(
      SupplyState.$typeName,
      ...typeArgs,
...
export function isRegulatedStateVariantName(
  variant: string,
): variant is RegulatedStateVariantName {
  return (
    variant === "Regulated" ||
    variant === "Unregulated" ||
    variant === "Unknown"
...
export class RegulatedState {
  ...
  static reified(): RegulatedStateReified {
    ...
    return {
      ...
      reifiedTypeArgs: [],
      fromFields: (fields: Record<string, any>) =>
        RegulatedState.fromFields([], fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        RegulatedState.fromFieldsWithTypes([], item),
      fromBcs: (data: Uint8Array) => RegulatedState.fromBcs([], data),
      bcs: reifiedBcs,
      fromJSONField: (field: any) => RegulatedState.fromJSONField([], field),
      fromJSON: (json: Record<string, any>) =>
        RegulatedState.fromJSON([], json),
      new: (
        variant: RegulatedStateVariantName,
        fields: RegulatedStateFields,
      ) => {
        switch (variant) {
          case "Regulated":
            return new RegulatedStateRegulated(
              [],
              fields as RegulatedStateRegulatedFields,
            );
          case "Unregulated":
            return new RegulatedStateUnregulated(
              [],
              fields as RegulatedStateUnregulatedFields,
            );
          case "Unknown":
            return new RegulatedStateUnknown(
              [],
              fields as RegulatedStateUnknownFields,
            );
        }
      },
      kind: "EnumClassReified",
  ...
  private static cachedBcs: ReturnType<
    typeof RegulatedState.instantiateBcs
  > | null = null;
  ...
  static fromFieldsWithTypes(
    ...
    const variant = (
      item as FieldsWithTypes & { variant: RegulatedStateVariantName }
    ).variant;
  ...
  static fromBcs(_typeArgs: [], data: Uint8Array): RegulatedStateVariant {
    const parsed = RegulatedState.bcs.parse(data);
    return RegulatedState.fromFields([], parsed);
  }

  static fromJSONField(_typeArgs: [], field: any): RegulatedStateVariant {
    const r = RegulatedState.reified();
    ...
    switch (kind) {
      case "Regulated":
        return r.new("Regulated", {
          ...
          allowGlobalPause: decodeFromJSONField(
            Option.reified("bool"),
            field.allowGlobalPause,
          ),
...
export class RegulatedStateRegulated implements EnumVariantClass {
  ...
  static readonly $typeName: typeof RegulatedState.$typeName =
    RegulatedState.$typeName;
  static readonly $numTypeParams: typeof RegulatedState.$numTypeParams =
    RegulatedState.$numTypeParams;
  static readonly $isPhantom: typeof RegulatedState.$isPhantom =
    RegulatedState.$isPhantom;
  static readonly $variantName = "Regulated" as const;

  readonly $typeName: typeof RegulatedStateRegulated.$typeName =
    RegulatedStateRegulated.$typeName;
  readonly $fullTypeName: `${typeof RegulatedState.$typeName}`;
  readonly $typeArgs: [];
  readonly $isPhantom: typeof RegulatedState.$isPhantom =
    RegulatedState.$isPhantom;
...
export class RegulatedStateUnregulated implements EnumVariantClass {
  ...
  constructor(typeArgs: [], _fields: RegulatedStateUnregulatedFields) {
    this.$fullTypeName = composeSuiType(
      RegulatedState.$typeName,
      ...typeArgs,
    ) as `${typeof RegulatedState.$typeName}`;
...
export class RegulatedStateUnknown implements EnumVariantClass {
  ...
  readonly $typeName: typeof RegulatedStateUnknown.$typeName =
    RegulatedStateUnknown.$typeName;
  readonly $fullTypeName: `${typeof RegulatedState.$typeName}`;
  readonly $typeArgs: [];
  readonly $isPhantom: typeof RegulatedState.$isPhantom =
    RegulatedState.$isPhantom;
  ...
  constructor(typeArgs: [], _fields: RegulatedStateUnknownFields) {
    this.$fullTypeName = composeSuiType(
      RegulatedState.$typeName,
      ...typeArgs,
    ) as `${typeof RegulatedState.$typeName}`;
...
export function isMetadataCapStateVariantName(
  ...
  return (
    variant === "Claimed" || variant === "Unclaimed" || variant === "Deleted"
  );
}
...
export class MetadataCapState {
  ...
  static reified(): MetadataCapStateReified {
    ...
    return {
      ...
      reifiedTypeArgs: [],
      fromFields: (fields: Record<string, any>) =>
        MetadataCapState.fromFields([], fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
      ...
      fromJSON: (json: Record<string, any>) =>
        MetadataCapState.fromJSON([], json),
      new: (
        variant: MetadataCapStateVariantName,
        fields: MetadataCapStateFields,
      ) => {
        switch (variant) {
          case "Claimed":
            return new MetadataCapStateClaimed(
              [],
              fields as MetadataCapStateClaimedFields,
            );
          case "Unclaimed":
            return new MetadataCapStateUnclaimed(
              [],
              fields as MetadataCapStateUnclaimedFields,
            );
          case "Deleted":
            return new MetadataCapStateDeleted(
              [],
              fields as MetadataCapStateDeletedFields,
            );
        }
      },
      kind: "EnumClassReified",
  ...
  private static cachedBcs: ReturnType<
    typeof MetadataCapState.instantiateBcs
  > | null = null;
  ...
  static fromFieldsWithTypes(
    ...
    const variant = (
      item as FieldsWithTypes & { variant: MetadataCapStateVariantName }
    ).variant;
  ...
  static fromBcs(_typeArgs: [], data: Uint8Array): MetadataCapStateVariant {
    const parsed = MetadataCapState.bcs.parse(data);
    return MetadataCapState.fromFields([], parsed);
  }

  static fromJSONField(_typeArgs: [], field: any): MetadataCapStateVariant {
    const r = MetadataCapState.reified();
...
export class MetadataCapStateClaimed implements EnumVariantClass {
  ...
  static readonly $typeName: typeof MetadataCapState.$typeName =
    MetadataCapState.$typeName;
  static readonly $numTypeParams: typeof MetadataCapState.$numTypeParams =
    MetadataCapState.$numTypeParams;
  static readonly $isPhantom: typeof MetadataCapState.$isPhantom =
    MetadataCapState.$isPhantom;
  static readonly $variantName = "Claimed" as const;

  readonly $typeName: typeof MetadataCapStateClaimed.$typeName =
    MetadataCapStateClaimed.$typeName;
  readonly $fullTypeName: `${typeof MetadataCapState.$typeName}`;
  readonly $typeArgs: [];
  readonly $isPhantom: typeof MetadataCapState.$isPhantom =
    MetadataCapState.$isPhantom;
...
export class MetadataCapStateUnclaimed implements EnumVariantClass {
  ...
  constructor(typeArgs: [], _fields: MetadataCapStateUnclaimedFields) {
    this.$fullTypeName = composeSuiType(
      MetadataCapState.$typeName,
      ...typeArgs,
    ) as `${typeof MetadataCapState.$typeName}`;
...
export class MetadataCapStateDeleted implements EnumVariantClass {
  ...
  readonly $typeName: typeof MetadataCapStateDeleted.$typeName =
    MetadataCapStateDeleted.$typeName;
  readonly $fullTypeName: `${typeof MetadataCapState.$typeName}`;
  readonly $typeArgs: [];
  readonly $isPhantom: typeof MetadataCapState.$isPhantom =
    MetadataCapState.$isPhantom;
  ...
  constructor(typeArgs: [], _fields: MetadataCapStateDeletedFields) {
    this.$fullTypeName = composeSuiType(
      MetadataCapState.$typeName,
      ...typeArgs,
    ) as `${typeof MetadataCapState.$typeName}`;
