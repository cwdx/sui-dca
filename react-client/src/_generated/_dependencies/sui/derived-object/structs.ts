...
export class Claimed implements StructClass {
  ...
  static reified(): ClaimedReified {
    ...
    return {
      ...
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        Claimed.fromFieldsWithTypes(item),
      ...
      fromSuiParsedData: (content: SuiParsedData) =>
        Claimed.fromSuiParsedData(content),
      fromSuiObjectData: (content: SuiObjectData) =>
        Claimed.fromSuiObjectData(content),
      fetch: async (client: SupportedSuiClient, id: string) =>
        Claimed.fetch(client, id),
  ...
  private static cachedBcs: ReturnType<typeof Claimed.instantiateBcs> | null =
    null;
  ...
  static fromSuiParsedData(content: SuiParsedData): Claimed {
    ...
    if (!isClaimed(content.type)) {
      throw new Error(
        `object at ${(content.fields as any).id} is not a Claimed object`,
      );
    }
...
export class DerivedObjectKey<K extends TypeArgument> implements StructClass {
  ...
  readonly $typeName: typeof DerivedObjectKey.$typeName =
  ...
  readonly $isPhantom: typeof DerivedObjectKey.$isPhantom =
    DerivedObjectKey.$isPhantom;

  readonly pos0: ToField<K>;

  private constructor(
    typeArgs: [ToTypeStr<K>],
    fields: DerivedObjectKeyFields<K>,
  ) {
    this.$fullTypeName = composeSuiType(
      DerivedObjectKey.$typeName,
      ...typeArgs,
  ...
  static reified<K extends Reified<TypeArgument, any>>(
    ...
    return {
      ...
      fromFields: (fields: Record<string, any>) =>
        DerivedObjectKey.fromFields(K, fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        DerivedObjectKey.fromFieldsWithTypes(K, item),
      fromBcs: (data: Uint8Array) =>
        DerivedObjectKey.fromFields(K, reifiedBcs.parse(data)),
      bcs: reifiedBcs,
      fromJSONField: (field: any) => DerivedObjectKey.fromJSONField(K, field),
      fromJSON: (json: Record<string, any>) =>
        DerivedObjectKey.fromJSON(K, json),
      fromSuiParsedData: (content: SuiParsedData) =>
        DerivedObjectKey.fromSuiParsedData(K, content),
      fromSuiObjectData: (content: SuiObjectData) =>
        DerivedObjectKey.fromSuiObjectData(K, content),
      fetch: async (client: SupportedSuiClient, id: string) =>
  ...
  private static cachedBcs: ReturnType<
    typeof DerivedObjectKey.instantiateBcs
  > | null = null;
  ...
  static fromBcs<K extends Reified<TypeArgument, any>>(
    ...
    return DerivedObjectKey.fromFields(
      typeArg,
      DerivedObjectKey.bcs(toBcs(typeArg)).parse(data),
    );
  }
  ...
  static fromSuiParsedData<K extends Reified<TypeArgument, any>>(
    ...
    if (!isDerivedObjectKey(content.type)) {
      throw new Error(
        `object at ${(content.fields as any).id} is not a DerivedObjectKey object`,
      );
    }
  ...
  static fromSuiObjectData<K extends Reified<TypeArgument, any>>(
    ...
    if (data.bcs) {
      if (
        ...
        !isDerivedObjectKey(data.bcs.type)
      ) {
...
export function isClaimedStatusVariantName(
  variant: string,
): variant is ClaimedStatusVariantName {
...
export class ClaimedStatus {
  ...
  static reified(): ClaimedStatusReified {
    ...
    return {
      ...
      reifiedTypeArgs: [],
      fromFields: (fields: Record<string, any>) =>
        ClaimedStatus.fromFields([], fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        ClaimedStatus.fromFieldsWithTypes([], item),
      ...
      new: (variant: ClaimedStatusVariantName, fields: ClaimedStatusFields) => {
        switch (variant) {
          case "Reserved":
            return new ClaimedStatusReserved(
              [],
              fields as ClaimedStatusReservedFields,
            );
        }
      },
  ...
  private static cachedBcs: ReturnType<
    typeof ClaimedStatus.instantiateBcs
  > | null = null;
  ...
  static fromFieldsWithTypes(
    ...
    const variant = (
      item as FieldsWithTypes & { variant: ClaimedStatusVariantName }
    ).variant;
  ...
  static fromBcs(_typeArgs: [], data: Uint8Array): ClaimedStatusVariant {
    const parsed = ClaimedStatus.bcs.parse(data);
    return ClaimedStatus.fromFields([], parsed);
  }

  static fromJSONField(_typeArgs: [], field: any): ClaimedStatusVariant {
    const r = ClaimedStatus.reified();
...
export class ClaimedStatusReserved implements EnumVariantClass {
  ...
  static readonly $typeName: typeof ClaimedStatus.$typeName =
    ClaimedStatus.$typeName;
  static readonly $numTypeParams: typeof ClaimedStatus.$numTypeParams =
    ClaimedStatus.$numTypeParams;
  static readonly $isPhantom: typeof ClaimedStatus.$isPhantom =
    ClaimedStatus.$isPhantom;
  static readonly $variantName = "Reserved" as const;

  readonly $typeName: typeof ClaimedStatusReserved.$typeName =
    ClaimedStatusReserved.$typeName;
  readonly $fullTypeName: `${typeof ClaimedStatus.$typeName}`;
  readonly $typeArgs: [];
  readonly $isPhantom: typeof ClaimedStatus.$isPhantom =
    ClaimedStatus.$isPhantom;
  readonly $variantName: typeof ClaimedStatusReserved.$variantName =
    ClaimedStatusReserved.$variantName;

  constructor(typeArgs: [], _fields: ClaimedStatusReservedFields) {
    this.$fullTypeName = composeSuiType(
      ClaimedStatus.$typeName,
      ...typeArgs,
