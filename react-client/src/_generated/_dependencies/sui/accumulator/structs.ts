...
export type AccumulatorRootReified = Reified<
  AccumulatorRoot,
  AccumulatorRootFields
>;
...
export class AccumulatorRoot implements StructClass {
  ...
  readonly $typeName: typeof AccumulatorRoot.$typeName =
    AccumulatorRoot.$typeName;
  readonly $fullTypeName: `0x2::accumulator::AccumulatorRoot`;
  readonly $typeArgs: [];
  readonly $isPhantom: typeof AccumulatorRoot.$isPhantom =
    AccumulatorRoot.$isPhantom;
  ...
  static reified(): AccumulatorRootReified {
    ...
    return {
      ...
      fromFields: (fields: Record<string, any>) =>
        AccumulatorRoot.fromFields(fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        AccumulatorRoot.fromFieldsWithTypes(item),
      fromBcs: (data: Uint8Array) =>
        AccumulatorRoot.fromFields(reifiedBcs.parse(data)),
      bcs: reifiedBcs,
      ...
      fromSuiParsedData: (content: SuiParsedData) =>
        AccumulatorRoot.fromSuiParsedData(content),
      fromSuiObjectData: (content: SuiObjectData) =>
        AccumulatorRoot.fromSuiObjectData(content),
      fetch: async (client: SupportedSuiClient, id: string) =>
        AccumulatorRoot.fetch(client, id),
  ...
  private static cachedBcs: ReturnType<
    typeof AccumulatorRoot.instantiateBcs
  > | null = null;
  ...
  static fromSuiParsedData(content: SuiParsedData): AccumulatorRoot {
    ...
    if (!isAccumulatorRoot(content.type)) {
      throw new Error(
        `object at ${(content.fields as any).id} is not a AccumulatorRoot object`,
      );
    }
  ...
  static fromSuiObjectData(data: SuiObjectData): AccumulatorRoot {
    if (data.bcs) {
      if (
        ...
        !isAccumulatorRoot(data.bcs.type)
      ) {
...
export class U128 implements StructClass {
  ...
  static reified(): U128Reified {
    ...
    return {
      ...
      fromSuiParsedData: (content: SuiParsedData) =>
        U128.fromSuiParsedData(content),
      fromSuiObjectData: (content: SuiObjectData) =>
        U128.fromSuiObjectData(content),
      fetch: async (client: SupportedSuiClient, id: string) =>
        U128.fetch(client, id),
  ...
  private static cachedBcs: ReturnType<typeof U128.instantiateBcs> | null =
    null;
  ...
  static fromSuiParsedData(content: SuiParsedData): U128 {
    ...
    if (!isU128(content.type)) {
      throw new Error(
        `object at ${(content.fields as any).id} is not a U128 object`,
      );
    }
...
export interface KeyFields<_T extends PhantomTypeArgument> {
...
export type KeyJSONField<_T extends PhantomTypeArgument> = {
  address: string;
};
...
export class Key<T extends PhantomTypeArgument> implements StructClass {
  ...
  static reified<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        Key.fromFieldsWithTypes(T, item),
      ...
      fromSuiParsedData: (content: SuiParsedData) =>
        Key.fromSuiParsedData(T, content),
      fromSuiObjectData: (content: SuiObjectData) =>
        Key.fromSuiObjectData(T, content),
      fetch: async (client: SupportedSuiClient, id: string) =>
        Key.fetch(client, T, id),
  ...
  static fromSuiParsedData<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    if (!isKey(content.type)) {
      throw new Error(
        `object at ${(content.fields as any).id} is not a Key object`,
      );
    }
