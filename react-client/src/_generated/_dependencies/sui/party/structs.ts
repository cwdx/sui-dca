...
export class Party implements StructClass {
  ...
  private static cachedBcs: ReturnType<typeof Party.instantiateBcs> | null =
    null;
...
export class Permissions implements StructClass {
  ...
  static readonly $typeName: `0x2::party::Permissions` =
    `0x2::party::Permissions` as const;
  static readonly $numTypeParams = 0;
  static readonly $isPhantom = [] as const;
  ...
  static reified(): PermissionsReified {
    ...
    return {
      ...
      fromBcs: (data: Uint8Array) =>
        Permissions.fromFields(reifiedBcs.parse(data)),
      bcs: reifiedBcs,
  ...
  private static cachedBcs: ReturnType<
    typeof Permissions.instantiateBcs
  > | null = null;
