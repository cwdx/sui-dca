...
export interface TransferRequestFields<_T extends PhantomTypeArgument> {
  /**
...
export type TransferRequestJSONField<_T extends PhantomTypeArgument> = {
  item: string;
  paid: string;
  from: string;
  ...
  implements StructClass
{
  ...
  readonly $typeName: typeof TransferRequest.$typeName =
    TransferRequest.$typeName;
  readonly $fullTypeName: `0x2::transfer_policy::TransferRequest<${PhantomToTypeStr<T>}>`;
  readonly $typeArgs: [PhantomToTypeStr<T>];
  readonly $isPhantom: typeof TransferRequest.$isPhantom =
    TransferRequest.$isPhantom;
...
export interface TransferPolicyFields<_T extends PhantomTypeArgument> {
  id: ToField<UID>;
  /**
...
export type TransferPolicyJSONField<_T extends PhantomTypeArgument> = {
  id: string;
  ...
  implements StructClass
{
  ...
  readonly $typeName: typeof TransferPolicy.$typeName =
    TransferPolicy.$typeName;
  readonly $fullTypeName: `0x2::transfer_policy::TransferPolicy<${PhantomToTypeStr<T>}>`;
  readonly $typeArgs: [PhantomToTypeStr<T>];
  readonly $isPhantom: typeof TransferPolicy.$isPhantom =
    TransferPolicy.$isPhantom;
...
export interface TransferPolicyCapFields<_T extends PhantomTypeArgument> {
  id: ToField<UID>;
  policyId: ToField<ID>;
}
...
export type TransferPolicyCapJSONField<_T extends PhantomTypeArgument> = {
  id: string;
  policyId: string;
};
  ...
  implements StructClass
{
  ...
  readonly $typeName: typeof TransferPolicyCap.$typeName =
    TransferPolicyCap.$typeName;
  readonly $fullTypeName: `0x2::transfer_policy::TransferPolicyCap<${PhantomToTypeStr<T>}>`;
  readonly $typeArgs: [PhantomToTypeStr<T>];
  readonly $isPhantom: typeof TransferPolicyCap.$isPhantom =
    TransferPolicyCap.$isPhantom;
...
export interface TransferPolicyCreatedFields<_T extends PhantomTypeArgument> {
  id: ToField<ID>;
}
...
export type TransferPolicyCreatedJSONField<_T extends PhantomTypeArgument> = {
  id: string;
};
  ...
  implements StructClass
{
  ...
  readonly $typeName: typeof TransferPolicyCreated.$typeName =
    TransferPolicyCreated.$typeName;
  readonly $fullTypeName: `0x2::transfer_policy::TransferPolicyCreated<${PhantomToTypeStr<T>}>`;
  readonly $typeArgs: [PhantomToTypeStr<T>];
  readonly $isPhantom: typeof TransferPolicyCreated.$isPhantom =
    TransferPolicyCreated.$isPhantom;
...
export interface TransferPolicyDestroyedFields<_T extends PhantomTypeArgument> {
  id: ToField<ID>;
}
...
export type TransferPolicyDestroyedJSONField<_T extends PhantomTypeArgument> = {
  id: string;
};
  ...
  implements StructClass
{
  ...
  readonly $typeName: typeof TransferPolicyDestroyed.$typeName =
...
export interface RuleKeyFields<_T extends PhantomTypeArgument> {
...
export type RuleKeyJSONField<_T extends PhantomTypeArgument> = {
  dummyField: boolean;
};
