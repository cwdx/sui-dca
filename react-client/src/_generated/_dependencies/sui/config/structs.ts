...
export interface ConfigFields<_WriteCap extends PhantomTypeArgument> {
  id: ToField<UID>;
}
...
export type ConfigJSONField<_WriteCap extends PhantomTypeArgument> = {
  id: string;
};
...
export class SettingData<Value extends TypeArgument> implements StructClass {
  ...
  static readonly $typeName: `0x2::config::SettingData` =
    `0x2::config::SettingData` as const;
  static readonly $numTypeParams = 1;
  static readonly $isPhantom = [false] as const;
