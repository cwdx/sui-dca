...
export interface ElementFields<_T extends PhantomTypeArgument> {
...
export type ElementJSONField<_T extends PhantomTypeArgument> = {
  bytes: number[];
};
...
export class Element<T extends PhantomTypeArgument> implements StructClass {
  ...
  static readonly $typeName: `0x2::group_ops::Element` =
    `0x2::group_ops::Element` as const;
