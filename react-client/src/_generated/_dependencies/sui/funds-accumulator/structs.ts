...
export interface WithdrawalFields<_T extends PhantomTypeArgument> {
...
export type WithdrawalJSONField<_T extends PhantomTypeArgument> = {
  owner: string;
  limit: string;
};
...
export class Withdrawal<T extends PhantomTypeArgument> implements StructClass {
  ...
  static reified<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      fromFields: (fields: Record<string, any>) =>
        Withdrawal.fromFields(T, fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        Withdrawal.fromFieldsWithTypes(T, item),
      fromBcs: (data: Uint8Array) =>
        Withdrawal.fromFields(T, reifiedBcs.parse(data)),
      bcs: reifiedBcs,
      ...
      fromSuiParsedData: (content: SuiParsedData) =>
        Withdrawal.fromSuiParsedData(T, content),
      fromSuiObjectData: (content: SuiObjectData) =>
        Withdrawal.fromSuiObjectData(T, content),
      fetch: async (client: SupportedSuiClient, id: string) =>
        Withdrawal.fetch(client, T, id),
  ...
  private static cachedBcs: ReturnType<
    typeof Withdrawal.instantiateBcs
  > | null = null;
  ...
  static fromSuiParsedData<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    if (!isWithdrawal(content.type)) {
      throw new Error(
        `object at ${(content.fields as any).id} is not a Withdrawal object`,
      );
    }
