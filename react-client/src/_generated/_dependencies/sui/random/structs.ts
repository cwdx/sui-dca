...
export class Random implements StructClass {
  ...
  private static cachedBcs: ReturnType<typeof Random.instantiateBcs> | null =
    null;
...
export class RandomInner implements StructClass {
  ...
  static readonly $typeName: `0x2::random::RandomInner` =
    `0x2::random::RandomInner` as const;
  static readonly $numTypeParams = 0;
  static readonly $isPhantom = [] as const;
  ...
  static reified(): RandomInnerReified {
    ...
    return {
      ...
      fromBcs: (data: Uint8Array) =>
        RandomInner.fromFields(reifiedBcs.parse(data)),
      bcs: reifiedBcs,
  ...
  private static cachedBcs: ReturnType<
    typeof RandomInner.instantiateBcs
  > | null = null;
...
export class RandomGenerator implements StructClass {
  ...
  readonly $typeName: typeof RandomGenerator.$typeName =
    RandomGenerator.$typeName;
  readonly $fullTypeName: `0x2::random::RandomGenerator`;
  readonly $typeArgs: [];
  readonly $isPhantom: typeof RandomGenerator.$isPhantom =
  ...
  static reified(): RandomGeneratorReified {
    ...
    return {
      ...
      fromBcs: (data: Uint8Array) =>
        RandomGenerator.fromFields(reifiedBcs.parse(data)),
      bcs: reifiedBcs,
  ...
  private static cachedBcs: ReturnType<
    typeof RandomGenerator.instantiateBcs
  > | null = null;
