...
export class OwnerKey implements StructClass {
  ...
  static reified(): OwnerKeyReified {
    ...
    return {
      ...
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        OwnerKey.fromFieldsWithTypes(item),
      fromBcs: (data: Uint8Array) =>
        OwnerKey.fromFields(reifiedBcs.parse(data)),
      bcs: reifiedBcs,
      fromJSONField: (field: any) => OwnerKey.fromJSONField(field),
      fromJSON: (json: Record<string, any>) => OwnerKey.fromJSON(json),
      fromSuiParsedData: (content: SuiParsedData) =>
        OwnerKey.fromSuiParsedData(content),
      fromSuiObjectData: (content: SuiObjectData) =>
        OwnerKey.fromSuiObjectData(content),
      fetch: async (client: SupportedSuiClient, id: string) =>
        OwnerKey.fetch(client, id),
  ...
  private static cachedBcs: ReturnType<typeof OwnerKey.instantiateBcs> | null =
    null;
  ...
  static fromSuiParsedData(content: SuiParsedData): OwnerKey {
    ...
    if (!isOwnerKey(content.type)) {
      throw new Error(
        `object at ${(content.fields as any).id} is not a OwnerKey object`,
      );
    }
...
export class Owner implements StructClass {
  ...
  static reified(): OwnerReified {
    ...
    return {
      ...
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        Owner.fromFieldsWithTypes(item),
      ...
      fromSuiParsedData: (content: SuiParsedData) =>
        Owner.fromSuiParsedData(content),
      fromSuiObjectData: (content: SuiObjectData) =>
        Owner.fromSuiObjectData(content),
      fetch: async (client: SupportedSuiClient, id: string) =>
        Owner.fetch(client, id),
  ...
  private static cachedBcs: ReturnType<typeof Owner.instantiateBcs> | null =
    null;
  ...
  static fromSuiParsedData(content: SuiParsedData): Owner {
    ...
    if (!isOwner(content.type)) {
      throw new Error(
        `object at ${(content.fields as any).id} is not a Owner object`,
      );
    }
...
export interface MetadataKeyFields<_T extends PhantomTypeArgument> {
...
export type MetadataKeyJSONField<_T extends PhantomTypeArgument> = {
  dummyField: boolean;
};
...
export class MetadataKey<T extends PhantomTypeArgument> implements StructClass {
  ...
  static reified<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      fromFields: (fields: Record<string, any>) =>
        MetadataKey.fromFields(T, fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        MetadataKey.fromFieldsWithTypes(T, item),
      fromBcs: (data: Uint8Array) =>
        MetadataKey.fromFields(T, reifiedBcs.parse(data)),
      bcs: reifiedBcs,
      fromJSONField: (field: any) => MetadataKey.fromJSONField(T, field),
      fromJSON: (json: Record<string, any>) => MetadataKey.fromJSON(T, json),
      fromSuiParsedData: (content: SuiParsedData) =>
        MetadataKey.fromSuiParsedData(T, content),
      fromSuiObjectData: (content: SuiObjectData) =>
        MetadataKey.fromSuiObjectData(T, content),
      fetch: async (client: SupportedSuiClient, id: string) =>
        MetadataKey.fetch(client, T, id),
  ...
  private static cachedBcs: ReturnType<
    typeof MetadataKey.instantiateBcs
  > | null = null;
  ...
  static fromSuiParsedData<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    if (!isMetadataKey(content.type)) {
      throw new Error(
        `object at ${(content.fields as any).id} is not a MetadataKey object`,
      );
    }
...
export interface MetadataFields<_T extends PhantomTypeArgument> {
  /** Any per-balance fields we wish to add in the future. */
  fields: ToField<Bag>;
}

export type MetadataReified<T extends PhantomTypeArgument> = Reified<
  Metadata<T>,
  MetadataFields<T>
>;

export type MetadataJSONField<_T extends PhantomTypeArgument> = {
  fields: ToJSON<Bag>;
};
...
export class Metadata<T extends PhantomTypeArgument> implements StructClass {
  ...
  static reified<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      reifiedTypeArgs: [T],
      fromFields: (fields: Record<string, any>) =>
        Metadata.fromFields(T, fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        Metadata.fromFieldsWithTypes(T, item),
      fromBcs: (data: Uint8Array) =>
        Metadata.fromFields(T, reifiedBcs.parse(data)),
      bcs: reifiedBcs,
      fromJSONField: (field: any) => Metadata.fromJSONField(T, field),
      fromJSON: (json: Record<string, any>) => Metadata.fromJSON(T, json),
      fromSuiParsedData: (content: SuiParsedData) =>
        Metadata.fromSuiParsedData(T, content),
      fromSuiObjectData: (content: SuiObjectData) =>
        Metadata.fromSuiObjectData(T, content),
      fetch: async (client: SupportedSuiClient, id: string) =>
        Metadata.fetch(client, T, id),
  ...
  private static cachedBcs: ReturnType<typeof Metadata.instantiateBcs> | null =
    null;
  ...
  static fromSuiParsedData<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    if (!isMetadata(content.type)) {
      throw new Error(
        `object at ${(content.fields as any).id} is not a Metadata object`,
      );
    }
...
export class AccumulatorObjectCountKey implements StructClass {
  ...
  static reified(): AccumulatorObjectCountKeyReified {
    ...
    return {
      ...
      reifiedTypeArgs: [],
      fromFields: (fields: Record<string, any>) =>
        AccumulatorObjectCountKey.fromFields(fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        AccumulatorObjectCountKey.fromFieldsWithTypes(item),
      fromBcs: (data: Uint8Array) =>
        AccumulatorObjectCountKey.fromFields(reifiedBcs.parse(data)),
      bcs: reifiedBcs,
      fromJSONField: (field: any) =>
        AccumulatorObjectCountKey.fromJSONField(field),
      fromJSON: (json: Record<string, any>) =>
        AccumulatorObjectCountKey.fromJSON(json),
      fromSuiParsedData: (content: SuiParsedData) =>
  ...
  private static cachedBcs: ReturnType<
    typeof AccumulatorObjectCountKey.instantiateBcs
  > | null = null;
  ...
  > {
    if (!AccumulatorObjectCountKey.cachedBcs) {
      AccumulatorObjectCountKey.cachedBcs =
        AccumulatorObjectCountKey.instantiateBcs();
    }
  ...
  static fromBcs(data: Uint8Array): AccumulatorObjectCountKey {
    return AccumulatorObjectCountKey.fromFields(
      AccumulatorObjectCountKey.bcs.parse(data),
    );
  }
  ...
  static fromSuiObjectData(data: SuiObjectData): AccumulatorObjectCountKey {
    if (data.bcs) {
      if (
        ...
        !isAccumulatorObjectCountKey(data.bcs.type)
      ) {
  ...
  static async fetch(
    client: SupportedSuiClient,
    id: string,
  ): Promise<AccumulatorObjectCountKey> {
    const res = await fetchObjectBcs(client, id);
    if (!isAccumulatorObjectCountKey(res.type)) {
      throw new Error(
        `object at id ${id} is not a AccumulatorObjectCountKey object`,
      );
    }
