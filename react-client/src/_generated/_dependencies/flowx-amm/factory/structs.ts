...
export function isContainer(type: string): boolean {
  ...
  return (
    type ===
    `${getTypeOrigin("flowx-amm", "factory::Container")}::factory::Container`
  );
}
...
export class Container implements StructClass {
  ...
  static readonly $typeName: `${string}::factory::Container` = `${getTypeOrigin(
    "flowx-amm",
    "factory::Container",
  ...
  static reified(): ContainerReified {
    ...
    return {
      ...
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        Container.fromFieldsWithTypes(item),
      fromBcs: (data: Uint8Array) =>
        Container.fromFields(reifiedBcs.parse(data)),
      bcs: reifiedBcs,
      fromJSONField: (field: any) => Container.fromJSONField(field),
      fromJSON: (json: Record<string, any>) => Container.fromJSON(json),
      fromSuiParsedData: (content: SuiParsedData) =>
        Container.fromSuiParsedData(content),
      fromSuiObjectData: (content: SuiObjectData) =>
        Container.fromSuiObjectData(content),
      fetch: async (client: SupportedSuiClient, id: string) =>
        Container.fetch(client, id),
  ...
  private static cachedBcs: ReturnType<typeof Container.instantiateBcs> | null =
    null;
  ...
  static fromSuiParsedData(content: SuiParsedData): Container {
    ...
    if (!isContainer(content.type)) {
      throw new Error(
        `object at ${(content.fields as any).id} is not a Container object`,
      );
    }
...
export function isAdminCap(type: string): boolean {
  ...
  return (
    type ===
    `${getTypeOrigin("flowx-amm", "factory::AdminCap")}::factory::AdminCap`
  );
}
...
export class AdminCap implements StructClass {
  ...
  static readonly $typeName: `${string}::factory::AdminCap` = `${getTypeOrigin(
    "flowx-amm",
    "factory::AdminCap",
...
export function isPairCreated(type: string): boolean {
  ...
  return (
    type ===
    `${getTypeOrigin("flowx-amm", "factory::PairCreated")}::factory::PairCreated`
  );
}
...
export class PairCreated implements StructClass {
  ...
  static reified(): PairCreatedReified {
    ...
    return {
      ...
      fromFields: (fields: Record<string, any>) =>
        PairCreated.fromFields(fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        PairCreated.fromFieldsWithTypes(item),
      fromBcs: (data: Uint8Array) =>
        PairCreated.fromFields(reifiedBcs.parse(data)),
      bcs: reifiedBcs,
      fromJSONField: (field: any) => PairCreated.fromJSONField(field),
      fromJSON: (json: Record<string, any>) => PairCreated.fromJSON(json),
      fromSuiParsedData: (content: SuiParsedData) =>
        PairCreated.fromSuiParsedData(content),
      fromSuiObjectData: (content: SuiObjectData) =>
        PairCreated.fromSuiObjectData(content),
      fetch: async (client: SupportedSuiClient, id: string) =>
        PairCreated.fetch(client, id),
  ...
  private static cachedBcs: ReturnType<
    typeof PairCreated.instantiateBcs
  > | null = null;
  ...
  static fromSuiParsedData(content: SuiParsedData): PairCreated {
    ...
    if (!isPairCreated(content.type)) {
      throw new Error(
        `object at ${(content.fields as any).id} is not a PairCreated object`,
      );
    }
...
export function isFeeChanged(type: string): boolean {
  ...
  return (
    type ===
    `${getTypeOrigin("flowx-amm", "factory::FeeChanged")}::factory::FeeChanged`
  );
}
...
export class FeeChanged implements StructClass {
  ...
  static reified(): FeeChangedReified {
    ...
    return {
      ...
      reifiedTypeArgs: [],
      fromFields: (fields: Record<string, any>) =>
        FeeChanged.fromFields(fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        FeeChanged.fromFieldsWithTypes(item),
      fromBcs: (data: Uint8Array) =>
        FeeChanged.fromFields(reifiedBcs.parse(data)),
      bcs: reifiedBcs,
      fromJSONField: (field: any) => FeeChanged.fromJSONField(field),
      fromJSON: (json: Record<string, any>) => FeeChanged.fromJSON(json),
      fromSuiParsedData: (content: SuiParsedData) =>
        FeeChanged.fromSuiParsedData(content),
      fromSuiObjectData: (content: SuiObjectData) =>
        FeeChanged.fromSuiObjectData(content),
      fetch: async (client: SupportedSuiClient, id: string) =>
        FeeChanged.fetch(client, id),
  ...
  private static cachedBcs: ReturnType<
    typeof FeeChanged.instantiateBcs
  > | null = null;
  ...
  static fromSuiParsedData(content: SuiParsedData): FeeChanged {
    ...
    if (!isFeeChanged(content.type)) {
      throw new Error(
        `object at ${(content.fields as any).id} is not a FeeChanged object`,
      );
    }
