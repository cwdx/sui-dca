...
export class GuardianSignature implements StructClass {
  ...
  readonly $typeName: typeof GuardianSignature.$typeName =
    GuardianSignature.$typeName;
  readonly $fullTypeName: `${string}::guardian_signature::GuardianSignature`;
  readonly $typeArgs: [];
  readonly $isPhantom: typeof GuardianSignature.$isPhantom =
    GuardianSignature.$isPhantom;
  ...
  static reified(): GuardianSignatureReified {
    ...
    return {
      ...
      fromBcs: (data: Uint8Array) =>
        GuardianSignature.fromFields(reifiedBcs.parse(data)),
      bcs: reifiedBcs,
  ...
  private static cachedBcs: ReturnType<
    typeof GuardianSignature.instantiateBcs
  > | null = null;
