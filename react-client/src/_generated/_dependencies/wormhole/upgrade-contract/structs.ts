...
export class ContractUpgraded implements StructClass {
  ...
  readonly $typeName: typeof ContractUpgraded.$typeName =
    ContractUpgraded.$typeName;
  readonly $fullTypeName: `${string}::upgrade_contract::ContractUpgraded`;
  readonly $typeArgs: [];
  readonly $isPhantom: typeof ContractUpgraded.$isPhantom =
    ContractUpgraded.$isPhantom;
  ...
  static reified(): ContractUpgradedReified {
    ...
    return {
      ...
      fromBcs: (data: Uint8Array) =>
        ContractUpgraded.fromFields(reifiedBcs.parse(data)),
      bcs: reifiedBcs,
  ...
  private static cachedBcs: ReturnType<
    typeof ContractUpgraded.instantiateBcs
  > | null = null;
...
export class UpgradeContract implements StructClass {
  ...
  readonly $typeName: typeof UpgradeContract.$typeName =
    UpgradeContract.$typeName;
  readonly $fullTypeName: `${string}::upgrade_contract::UpgradeContract`;
  readonly $typeArgs: [];
  readonly $isPhantom: typeof UpgradeContract.$isPhantom =
    UpgradeContract.$isPhantom;
  ...
  static reified(): UpgradeContractReified {
    ...
    return {
      ...
      fromBcs: (data: Uint8Array) =>
        UpgradeContract.fromFields(reifiedBcs.parse(data)),
      bcs: reifiedBcs,
  ...
  private static cachedBcs: ReturnType<
    typeof UpgradeContract.instantiateBcs
  > | null = null;
