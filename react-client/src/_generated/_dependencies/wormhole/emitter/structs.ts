...
export function isEmitterCreated(type: string): boolean {
  ...
  return (
    type ===
    `${getTypeOrigin("wormhole", "emitter::EmitterCreated")}::emitter::EmitterCreated`
  );
}
...
export class EmitterCreated implements StructClass {
  ...
  readonly $typeName: typeof EmitterCreated.$typeName =
    EmitterCreated.$typeName;
  readonly $fullTypeName: `${string}::emitter::EmitterCreated`;
  readonly $typeArgs: [];
  readonly $isPhantom: typeof EmitterCreated.$isPhantom =
    EmitterCreated.$isPhantom;
  ...
  static reified(): EmitterCreatedReified {
    ...
    return {
      ...
      fromBcs: (data: Uint8Array) =>
        EmitterCreated.fromFields(reifiedBcs.parse(data)),
      bcs: reifiedBcs,
  ...
  private static cachedBcs: ReturnType<
    typeof EmitterCreated.instantiateBcs
  > | null = null;
...
export class EmitterDestroyed implements StructClass {
  ...
  readonly $typeName: typeof EmitterDestroyed.$typeName =
    EmitterDestroyed.$typeName;
  readonly $fullTypeName: `${string}::emitter::EmitterDestroyed`;
  readonly $typeArgs: [];
  readonly $isPhantom: typeof EmitterDestroyed.$isPhantom =
    EmitterDestroyed.$isPhantom;
  ...
  static reified(): EmitterDestroyedReified {
    ...
    return {
      ...
      fromBcs: (data: Uint8Array) =>
        EmitterDestroyed.fromFields(reifiedBcs.parse(data)),
      bcs: reifiedBcs,
  ...
  private static cachedBcs: ReturnType<
    typeof EmitterDestroyed.instantiateBcs
  > | null = null;
...
export function isEmitterCap(type: string): boolean {
  ...
  return (
    type ===
    `${getTypeOrigin("wormhole", "emitter::EmitterCap")}::emitter::EmitterCap`
  );
}
...
export class EmitterCap implements StructClass {
  ...
  static reified(): EmitterCapReified {
    ...
    return {
      ...
      fromBcs: (data: Uint8Array) =>
        EmitterCap.fromFields(reifiedBcs.parse(data)),
      bcs: reifiedBcs,
  ...
  private static cachedBcs: ReturnType<
    typeof EmitterCap.instantiateBcs
  > | null = null;
