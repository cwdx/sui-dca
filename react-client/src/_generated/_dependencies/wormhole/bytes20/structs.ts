...
export function isBytes20(type: string): boolean {
  ...
  return (
    type ===
    `${getTypeOrigin("wormhole", "bytes20::Bytes20")}::bytes20::Bytes20`
  );
}
...
export class Bytes20 implements StructClass {
  ...
  static readonly $typeName: `${string}::bytes20::Bytes20` = `${getTypeOrigin(
    "wormhole",
    "bytes20::Bytes20",
  ...
  private static cachedBcs: ReturnType<typeof Bytes20.instantiateBcs> | null =
    null;
