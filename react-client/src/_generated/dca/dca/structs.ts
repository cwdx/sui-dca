...
export function isTradePromise(type: string): boolean {
  ...
  return type.startsWith(
    `${getTypeOrigin("dca", "dca::TradePromise")}::dca::TradePromise<`,
  );
}

export interface TradePromiseFields<
  _Input extends PhantomTypeArgument,
  _Output extends PhantomTypeArgument,
> {
  input: ToField<"u64">;
...
> implements StructClass
{
  ...
  static readonly $typeName: `${string}::dca::TradePromise` = `${getTypeOrigin(
    "dca",
    "dca::TradePromise",
  ...
  readonly $fullTypeName: `${string}::dca::TradePromise<${PhantomToTypeStr<Input>}, ${PhantomToTypeStr<Output>}>`;
  ...
  > {
    ...
    return {
      ...
      fromFields: (fields: Record<string, any>) =>
        TradePromise.fromFields([Input, Output], fields),
      ...
      fromJSONField: (field: any) =>
        TradePromise.fromJSONField([Input, Output], field),
      fromJSON: (json: Record<string, any>) =>
        TradePromise.fromJSON([Input, Output], json),
  ...
  private static cachedBcs: ReturnType<
    typeof TradePromise.instantiateBcs
  > | null = null;
  ...
  >(
    ...
    if (!isTradePromise(content.type)) {
      throw new Error(
        `object at ${(content.fields as any).id} is not a TradePromise object`,
      );
    }
...
export class Price implements StructClass {
  ...
  static readonly $typeName: `${string}::dca::Price` = `${getTypeOrigin(
    "dca",
    "dca::Price",
  )}::dca::Price` as const;
  ...
  private static cachedBcs: ReturnType<typeof Price.instantiateBcs> | null =
    null;
...
export function isTradeParams(type: string): boolean {
  type = compressSuiType(type);
  return (
    type === `${getTypeOrigin("dca", "dca::TradeParams")}::dca::TradeParams`
  );
}
...
export class TradeParams implements StructClass {
  ...
  static readonly $typeName: `${string}::dca::TradeParams` = `${getTypeOrigin(
    "dca",
    "dca::TradeParams",
  ...
  static reified(): TradeParamsReified {
    ...
    return {
      ...
      reifiedTypeArgs: [],
      fromFields: (fields: Record<string, any>) =>
        TradeParams.fromFields(fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        TradeParams.fromFieldsWithTypes(item),
      fromBcs: (data: Uint8Array) =>
        TradeParams.fromFields(reifiedBcs.parse(data)),
      bcs: reifiedBcs,
      fromJSONField: (field: any) => TradeParams.fromJSONField(field),
      fromJSON: (json: Record<string, any>) => TradeParams.fromJSON(json),
      fromSuiParsedData: (content: SuiParsedData) =>
        TradeParams.fromSuiParsedData(content),
      fromSuiObjectData: (content: SuiObjectData) =>
        TradeParams.fromSuiObjectData(content),
      fetch: async (client: SupportedSuiClient, id: string) =>
        TradeParams.fetch(client, id),
  ...
  private static cachedBcs: ReturnType<
    typeof TradeParams.instantiateBcs
  > | null = null;
  ...
  static fromFields(fields: Record<string, any>): TradeParams {
    return TradeParams.reified().new({
      minPrice: decodeFromFields(
        Option.reified(Price.reified()),
        fields.min_price,
      ),
      maxPrice: decodeFromFields(
        Option.reified(Price.reified()),
        fields.max_price,
      ),
  ...
  static fromFieldsWithTypes(item: FieldsWithTypes): TradeParams {
    ...
    return TradeParams.reified().new({
      minPrice: decodeFromFieldsWithTypes(
        Option.reified(Price.reified()),
        item.fields.min_price,
      ),
      maxPrice: decodeFromFieldsWithTypes(
        Option.reified(Price.reified()),
        item.fields.max_price,
      ),
      slippageBps: decodeFromFieldsWithTypes(
        Option.reified("u64"),
        item.fields.slippage_bps,
      ),
    });
  }
  ...
  toJSONField(): TradeParamsJSONField {
    return {
      ...
      slippageBps: fieldToJSON<Option<"u64">>(
        `${Option.$typeName}<u64>`,
        this.slippageBps,
      ),
    };
  ...
  static fromJSONField(field: any): TradeParams {
    return TradeParams.reified().new({
      minPrice: decodeFromJSONField(
        Option.reified(Price.reified()),
        field.minPrice,
      ),
      maxPrice: decodeFromJSONField(
        Option.reified(Price.reified()),
        field.maxPrice,
      ),
      slippageBps: decodeFromJSONField(
        Option.reified("u64"),
        field.slippageBps,
      ),
    });
  ...
  static fromSuiParsedData(content: SuiParsedData): TradeParams {
    ...
    if (!isTradeParams(content.type)) {
      throw new Error(
        `object at ${(content.fields as any).id} is not a TradeParams object`,
      );
    }
...
> implements StructClass
{
  ...
  static readonly $typeName: `${string}::dca::DCA` = `${getTypeOrigin(
    "dca",
    "dca::DCA",
  )}::dca::DCA` as const;
  static readonly $numTypeParams = 2;
  ...
  readonly $fullTypeName: `${string}::dca::DCA<${PhantomToTypeStr<Input>}, ${PhantomToTypeStr<Output>}>`;
  readonly $typeArgs: [PhantomToTypeStr<Input>, PhantomToTypeStr<Output>];
  ...
  >(
    ...
    return {
      ...
      reifiedTypeArgs: [Input, Output],
      fromFields: (fields: Record<string, any>) =>
        DCA.fromFields([Input, Output], fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        DCA.fromFieldsWithTypes([Input, Output], item),
      fromBcs: (data: Uint8Array) =>
        DCA.fromFields([Input, Output], reifiedBcs.parse(data)),
      bcs: reifiedBcs,
      fromJSONField: (field: any) => DCA.fromJSONField([Input, Output], field),
      fromJSON: (json: Record<string, any>) =>
        DCA.fromJSON([Input, Output], json),
      fromSuiParsedData: (content: SuiParsedData) =>
  ...
  >(
    ...
    ToTypeStr<DCA<ToPhantomTypeArgument<Input>, ToPhantomTypeArgument<Output>>>
  > {
  ...
  >(
    ...
    return DCA.reified(typeArgs[0], typeArgs[1]).new({
      ...
      inputBalance: decodeFromFields(
        Balance.reified(typeArgs[0]),
        fields.input_balance,
      ),
      ...
      configSnapshot: decodeFromFields(
        ConfigSnapshot.reified(),
        fields.config_snapshot,
      ),
      acceptedTermsVersion: decodeFromFields(
        "u64",
        fields.accepted_terms_version,
      ),
  ...
  >(
    ...
    return DCA.reified(typeArgs[0], typeArgs[1]).new({
      ...
      initialOrders: decodeFromFieldsWithTypes(
        "u64",
        item.fields.initial_orders,
      ),
      remainingOrders: decodeFromFieldsWithTypes(
        "u64",
        item.fields.remaining_orders,
      ),
      ...
      splitAllocation: decodeFromFieldsWithTypes(
        "u64",
        item.fields.split_allocation,
      ),
      tradeParams: decodeFromFieldsWithTypes(
        TradeParams.reified(),
        item.fields.trade_params,
      ),
      ...
      acceptedTermsVersion: decodeFromFieldsWithTypes(
        "u64",
        item.fields.accepted_terms_version,
      ),
      inputDecimals: decodeFromFieldsWithTypes(
        "u8",
        item.fields.input_decimals,
      ),
      outputDecimals: decodeFromFieldsWithTypes(
        "u8",
        item.fields.output_decimals,
      ),
    });
  }
  ...
  >(
    ...
    return DCA.reified(typeArgs[0], typeArgs[1]).new({
      ...
      inputBalance: decodeFromJSONField(
        Balance.reified(typeArgs[0]),
        field.inputBalance,
      ),
      ...
      configSnapshot: decodeFromJSONField(
        ConfigSnapshot.reified(),
        field.configSnapshot,
      ),
      acceptedTermsVersion: decodeFromJSONField(
        "u64",
  ...
  >(
    ...
    if (!isDCA(content.type)) {
      throw new Error(
        `object at ${(content.fields as any).id} is not a DCA object`,
      );
    }
...
export function isDCACreatedEvent(type: string): boolean {
  ...
  return (
    type ===
    `${getTypeOrigin("dca", "dca::DCACreatedEvent")}::dca::DCACreatedEvent`
  );
}
...
export class DCACreatedEvent implements StructClass {
  ...
  readonly $typeName: typeof DCACreatedEvent.$typeName =
    DCACreatedEvent.$typeName;
  readonly $fullTypeName: `${string}::dca::DCACreatedEvent`;
  readonly $typeArgs: [];
  readonly $isPhantom: typeof DCACreatedEvent.$isPhantom =
    DCACreatedEvent.$isPhantom;
  ...
  static reified(): DCACreatedEventReified {
    ...
    return {
      ...
      reifiedTypeArgs: [],
      fromFields: (fields: Record<string, any>) =>
        DCACreatedEvent.fromFields(fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        DCACreatedEvent.fromFieldsWithTypes(item),
      fromBcs: (data: Uint8Array) =>
        DCACreatedEvent.fromFields(reifiedBcs.parse(data)),
      bcs: reifiedBcs,
      fromJSONField: (field: any) => DCACreatedEvent.fromJSONField(field),
      fromJSON: (json: Record<string, any>) => DCACreatedEvent.fromJSON(json),
      fromSuiParsedData: (content: SuiParsedData) =>
        DCACreatedEvent.fromSuiParsedData(content),
      fromSuiObjectData: (content: SuiObjectData) =>
        DCACreatedEvent.fromSuiObjectData(content),
      fetch: async (client: SupportedSuiClient, id: string) =>
        DCACreatedEvent.fetch(client, id),
  ...
  private static cachedBcs: ReturnType<
    typeof DCACreatedEvent.instantiateBcs
  > | null = null;
  ...
  static fromSuiParsedData(content: SuiParsedData): DCACreatedEvent {
    ...
    if (!isDCACreatedEvent(content.type)) {
      throw new Error(
        `object at ${(content.fields as any).id} is not a DCACreatedEvent object`,
      );
    }
  ...
  static fromSuiObjectData(data: SuiObjectData): DCACreatedEvent {
    if (data.bcs) {
      if (
        data.bcs.dataType !== "moveObject" ||
        !isDCACreatedEvent(data.bcs.type)
      ) {
...
export function isTradeInitiatedEvent(type: string): boolean {
  ...
  return (
    type ===
    `${getTypeOrigin("dca", "dca::TradeInitiatedEvent")}::dca::TradeInitiatedEvent`
  );
}
...
export type TradeInitiatedEventReified = Reified<
  TradeInitiatedEvent,
  TradeInitiatedEventFields
>;
...
export class TradeInitiatedEvent implements StructClass {
  ...
  readonly $typeName: typeof TradeInitiatedEvent.$typeName =
    TradeInitiatedEvent.$typeName;
  readonly $fullTypeName: `${string}::dca::TradeInitiatedEvent`;
  readonly $typeArgs: [];
  readonly $isPhantom: typeof TradeInitiatedEvent.$isPhantom =
    TradeInitiatedEvent.$isPhantom;
  ...
  static reified(): TradeInitiatedEventReified {
    ...
    return {
      ...
      reifiedTypeArgs: [],
      fromFields: (fields: Record<string, any>) =>
        TradeInitiatedEvent.fromFields(fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        TradeInitiatedEvent.fromFieldsWithTypes(item),
      fromBcs: (data: Uint8Array) =>
        TradeInitiatedEvent.fromFields(reifiedBcs.parse(data)),
      bcs: reifiedBcs,
      fromJSONField: (field: any) => TradeInitiatedEvent.fromJSONField(field),
      fromJSON: (json: Record<string, any>) =>
        TradeInitiatedEvent.fromJSON(json),
      fromSuiParsedData: (content: SuiParsedData) =>
        TradeInitiatedEvent.fromSuiParsedData(content),
      fromSuiObjectData: (content: SuiObjectData) =>
        TradeInitiatedEvent.fromSuiObjectData(content),
      fetch: async (client: SupportedSuiClient, id: string) =>
  ...
  private static cachedBcs: ReturnType<
    typeof TradeInitiatedEvent.instantiateBcs
  > | null = null;
  ...
  static fromSuiParsedData(content: SuiParsedData): TradeInitiatedEvent {
    ...
    if (!isTradeInitiatedEvent(content.type)) {
      throw new Error(
        `object at ${(content.fields as any).id} is not a TradeInitiatedEvent object`,
      );
    }
  ...
  static fromSuiObjectData(data: SuiObjectData): TradeInitiatedEvent {
    if (data.bcs) {
      if (
        data.bcs.dataType !== "moveObject" ||
        !isTradeInitiatedEvent(data.bcs.type)
      ) {
...
export function isTradeCompletedEvent(type: string): boolean {
  ...
  return (
    type ===
    `${getTypeOrigin("dca", "dca::TradeCompletedEvent")}::dca::TradeCompletedEvent`
  );
}
...
export type TradeCompletedEventReified = Reified<
  TradeCompletedEvent,
  TradeCompletedEventFields
>;
...
export class TradeCompletedEvent implements StructClass {
  ...
  readonly $typeName: typeof TradeCompletedEvent.$typeName =
    TradeCompletedEvent.$typeName;
  readonly $fullTypeName: `${string}::dca::TradeCompletedEvent`;
  readonly $typeArgs: [];
  readonly $isPhantom: typeof TradeCompletedEvent.$isPhantom =
    TradeCompletedEvent.$isPhantom;
  ...
  static reified(): TradeCompletedEventReified {
    ...
    return {
      ...
      reifiedTypeArgs: [],
      fromFields: (fields: Record<string, any>) =>
        TradeCompletedEvent.fromFields(fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        TradeCompletedEvent.fromFieldsWithTypes(item),
      fromBcs: (data: Uint8Array) =>
        TradeCompletedEvent.fromFields(reifiedBcs.parse(data)),
      bcs: reifiedBcs,
      fromJSONField: (field: any) => TradeCompletedEvent.fromJSONField(field),
      fromJSON: (json: Record<string, any>) =>
        TradeCompletedEvent.fromJSON(json),
      fromSuiParsedData: (content: SuiParsedData) =>
        TradeCompletedEvent.fromSuiParsedData(content),
      fromSuiObjectData: (content: SuiObjectData) =>
        TradeCompletedEvent.fromSuiObjectData(content),
      fetch: async (client: SupportedSuiClient, id: string) =>
  ...
  private static cachedBcs: ReturnType<
    typeof TradeCompletedEvent.instantiateBcs
  > | null = null;
  ...
  static fromFieldsWithTypes(item: FieldsWithTypes): TradeCompletedEvent {
    ...
    return TradeCompletedEvent.reified().new({
      ...
      executorReward: decodeFromFieldsWithTypes(
        "u64",
        item.fields.executor_reward,
      ),
      active: decodeFromFieldsWithTypes("bool", item.fields.active),
    });
  }
  ...
  static fromSuiParsedData(content: SuiParsedData): TradeCompletedEvent {
    ...
    if (!isTradeCompletedEvent(content.type)) {
      throw new Error(
        `object at ${(content.fields as any).id} is not a TradeCompletedEvent object`,
      );
    }
  ...
  static fromSuiObjectData(data: SuiObjectData): TradeCompletedEvent {
    if (data.bcs) {
      if (
        data.bcs.dataType !== "moveObject" ||
        !isTradeCompletedEvent(data.bcs.type)
      ) {
...
export function isDCADeactivatedEvent(type: string): boolean {
  ...
  return (
    type ===
    `${getTypeOrigin("dca", "dca::DCADeactivatedEvent")}::dca::DCADeactivatedEvent`
  );
}
...
export type DCADeactivatedEventReified = Reified<
  DCADeactivatedEvent,
  DCADeactivatedEventFields
>;
...
export class DCADeactivatedEvent implements StructClass {
  ...
  readonly $typeName: typeof DCADeactivatedEvent.$typeName =
    DCADeactivatedEvent.$typeName;
  readonly $fullTypeName: `${string}::dca::DCADeactivatedEvent`;
  readonly $typeArgs: [];
  readonly $isPhantom: typeof DCADeactivatedEvent.$isPhantom =
    DCADeactivatedEvent.$isPhantom;
  ...
  static reified(): DCADeactivatedEventReified {
    ...
    return {
      ...
      reifiedTypeArgs: [],
      fromFields: (fields: Record<string, any>) =>
        DCADeactivatedEvent.fromFields(fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        DCADeactivatedEvent.fromFieldsWithTypes(item),
      fromBcs: (data: Uint8Array) =>
        DCADeactivatedEvent.fromFields(reifiedBcs.parse(data)),
      bcs: reifiedBcs,
      fromJSONField: (field: any) => DCADeactivatedEvent.fromJSONField(field),
      fromJSON: (json: Record<string, any>) =>
        DCADeactivatedEvent.fromJSON(json),
      fromSuiParsedData: (content: SuiParsedData) =>
        DCADeactivatedEvent.fromSuiParsedData(content),
      fromSuiObjectData: (content: SuiObjectData) =>
        DCADeactivatedEvent.fromSuiObjectData(content),
      fetch: async (client: SupportedSuiClient, id: string) =>
  ...
  private static cachedBcs: ReturnType<
    typeof DCADeactivatedEvent.instantiateBcs
  > | null = null;
  ...
  static fromFields(fields: Record<string, any>): DCADeactivatedEvent {
    return DCADeactivatedEvent.reified().new({
      ...
      remainingExecutorReward: decodeFromFields(
        "u64",
        fields.remaining_executor_reward,
      ),
    });
  }
  ...
  static fromFieldsWithTypes(item: FieldsWithTypes): DCADeactivatedEvent {
    ...
    return DCADeactivatedEvent.reified().new({
      ...
      remainingInput: decodeFromFieldsWithTypes(
        "u64",
        item.fields.remaining_input,
      ),
  ...
  static fromJSONField(field: any): DCADeactivatedEvent {
    return DCADeactivatedEvent.reified().new({
      ...
      remainingExecutorReward: decodeFromJSONField(
        "u64",
        field.remainingExecutorReward,
      ),
    });
  }
  ...
  static fromSuiParsedData(content: SuiParsedData): DCADeactivatedEvent {
    ...
    if (!isDCADeactivatedEvent(content.type)) {
      throw new Error(
        `object at ${(content.fields as any).id} is not a DCADeactivatedEvent object`,
      );
    }
  ...
  static fromSuiObjectData(data: SuiObjectData): DCADeactivatedEvent {
    if (data.bcs) {
      if (
        data.bcs.dataType !== "moveObject" ||
        !isDCADeactivatedEvent(data.bcs.type)
      ) {
...
export class DelegateeUpdatedEvent implements StructClass {
  ...
  readonly $typeName: typeof DelegateeUpdatedEvent.$typeName =
    DelegateeUpdatedEvent.$typeName;
  readonly $fullTypeName: `${string}::dca::DelegateeUpdatedEvent`;
  readonly $typeArgs: [];
  readonly $isPhantom: typeof DelegateeUpdatedEvent.$isPhantom =
    DelegateeUpdatedEvent.$isPhantom;
  ...
  static reified(): DelegateeUpdatedEventReified {
    ...
    return {
      ...
      reifiedTypeArgs: [],
      fromFields: (fields: Record<string, any>) =>
        DelegateeUpdatedEvent.fromFields(fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        DelegateeUpdatedEvent.fromFieldsWithTypes(item),
      fromBcs: (data: Uint8Array) =>
        DelegateeUpdatedEvent.fromFields(reifiedBcs.parse(data)),
      bcs: reifiedBcs,
      fromJSONField: (field: any) => DelegateeUpdatedEvent.fromJSONField(field),
      fromJSON: (json: Record<string, any>) =>
        DelegateeUpdatedEvent.fromJSON(json),
      fromSuiParsedData: (content: SuiParsedData) =>
  ...
  private static cachedBcs: ReturnType<
    typeof DelegateeUpdatedEvent.instantiateBcs
  > | null = null;
  ...
  static fromFieldsWithTypes(item: FieldsWithTypes): DelegateeUpdatedEvent {
    ...
    return DelegateeUpdatedEvent.reified().new({
      dcaId: decodeFromFieldsWithTypes(ID.reified(), item.fields.dca_id),
      oldDelegatee: decodeFromFieldsWithTypes(
        "address",
        item.fields.old_delegatee,
      ),
      newDelegatee: decodeFromFieldsWithTypes(
        "address",
        item.fields.new_delegatee,
      ),
    });
  }

  static fromBcs(data: Uint8Array): DelegateeUpdatedEvent {
    return DelegateeUpdatedEvent.fromFields(
      DelegateeUpdatedEvent.bcs.parse(data),
    );
  }
  ...
  static fromSuiObjectData(data: SuiObjectData): DelegateeUpdatedEvent {
    if (data.bcs) {
      if (
        data.bcs.dataType !== "moveObject" ||
        !isDelegateeUpdatedEvent(data.bcs.type)
      ) {
  ...
  static async fetch(
    client: SupportedSuiClient,
    id: string,
  ): Promise<DelegateeUpdatedEvent> {
    const res = await fetchObjectBcs(client, id);
    if (!isDelegateeUpdatedEvent(res.type)) {
      throw new Error(
        `object at id ${id} is not a DelegateeUpdatedEvent object`,
      );
    }
...
export function isSlippageUpdatedEvent(type: string): boolean {
  ...
  return (
    type ===
    `${getTypeOrigin("dca", "dca::SlippageUpdatedEvent")}::dca::SlippageUpdatedEvent`
  );
}
...
export type SlippageUpdatedEventReified = Reified<
  SlippageUpdatedEvent,
  SlippageUpdatedEventFields
>;
...
export class SlippageUpdatedEvent implements StructClass {
  ...
  readonly $typeName: typeof SlippageUpdatedEvent.$typeName =
    SlippageUpdatedEvent.$typeName;
  readonly $fullTypeName: `${string}::dca::SlippageUpdatedEvent`;
  readonly $typeArgs: [];
  readonly $isPhantom: typeof SlippageUpdatedEvent.$isPhantom =
    SlippageUpdatedEvent.$isPhantom;
  ...
  static reified(): SlippageUpdatedEventReified {
    ...
    return {
      ...
      reifiedTypeArgs: [],
      fromFields: (fields: Record<string, any>) =>
        SlippageUpdatedEvent.fromFields(fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        SlippageUpdatedEvent.fromFieldsWithTypes(item),
      fromBcs: (data: Uint8Array) =>
        SlippageUpdatedEvent.fromFields(reifiedBcs.parse(data)),
      bcs: reifiedBcs,
      fromJSONField: (field: any) => SlippageUpdatedEvent.fromJSONField(field),
      fromJSON: (json: Record<string, any>) =>
        SlippageUpdatedEvent.fromJSON(json),
      fromSuiParsedData: (content: SuiParsedData) =>
  ...
  private static cachedBcs: ReturnType<
    typeof SlippageUpdatedEvent.instantiateBcs
  > | null = null;
  ...
  static fromFields(fields: Record<string, any>): SlippageUpdatedEvent {
    return SlippageUpdatedEvent.reified().new({
      dcaId: decodeFromFields(ID.reified(), fields.dca_id),
      oldSlippageBps: decodeFromFields(
        Option.reified("u64"),
        fields.old_slippage_bps,
      ),
      newSlippageBps: decodeFromFields(
        Option.reified("u64"),
        fields.new_slippage_bps,
      ),
    });
  }
  ...
  static fromBcs(data: Uint8Array): SlippageUpdatedEvent {
    return SlippageUpdatedEvent.fromFields(
      SlippageUpdatedEvent.bcs.parse(data),
    );
  }
  ...
  toJSONField(): SlippageUpdatedEventJSONField {
    return {
      dcaId: this.dcaId,
      oldSlippageBps: fieldToJSON<Option<"u64">>(
        `${Option.$typeName}<u64>`,
        this.oldSlippageBps,
      ),
      newSlippageBps: fieldToJSON<Option<"u64">>(
        `${Option.$typeName}<u64>`,
        this.newSlippageBps,
      ),
    };
  ...
  static fromJSONField(field: any): SlippageUpdatedEvent {
    return SlippageUpdatedEvent.reified().new({
      dcaId: decodeFromJSONField(ID.reified(), field.dcaId),
      oldSlippageBps: decodeFromJSONField(
        Option.reified("u64"),
        field.oldSlippageBps,
      ),
      newSlippageBps: decodeFromJSONField(
        Option.reified("u64"),
        field.newSlippageBps,
      ),
    });
  }
  ...
  static fromSuiObjectData(data: SuiObjectData): SlippageUpdatedEvent {
    if (data.bcs) {
      if (
        data.bcs.dataType !== "moveObject" ||
        !isSlippageUpdatedEvent(data.bcs.type)
      ) {
  ...
  static async fetch(
    client: SupportedSuiClient,
    id: string,
  ): Promise<SlippageUpdatedEvent> {
    const res = await fetchObjectBcs(client, id);
    if (!isSlippageUpdatedEvent(res.type)) {
      throw new Error(
        `object at id ${id} is not a SlippageUpdatedEvent object`,
      );
    }
