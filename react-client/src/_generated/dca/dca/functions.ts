...
export function initTradeLegacy(
  ...
  return tx.moveCall({
    ...
    typeArguments: typeArgs,
    arguments: [obj(tx, args.dca), obj(tx, args.clock)],
  });
}
...
export function emitDeactivationEvent(
  ...
  return tx.moveCall({
    ...
    typeArguments: typeArgs,
    arguments: [obj(tx, args.dca), pure(tx, args.reason, `u8`)],
  });
}
...
export function feeAmountWithBps(
  tx: Transaction,
  args: FeeAmountWithBpsArgs,
): TransactionResult {
  return tx.moveCall({
...
export function intervalToSeconds(
  tx: Transaction,
  args: IntervalToSecondsArgs,
): TransactionResult {
  return tx.moveCall({
    target: `${getPublishedAt("dca")}::dca::interval_to_seconds`,
    arguments: [pure(tx, args.every, `u64`), pure(tx, args.timeScale, `u8`)],
  });
}
...
export function getMinOutputAmount(
  ...
  return tx.moveCall({
    ...
    typeArguments: typeArgs,
    arguments: [obj(tx, args.dca), pure(tx, args.inputAmount, `u64`)],
  });
}
...
export function assertMaxPriceViaOutput(
  ...
  return tx.moveCall({
    ...
    typeArguments: typeArgs,
    arguments: [pure(tx, args.outputAmount, `u64`), obj(tx, args.promise)],
  });
}
...
export function setDelegatee(
  ...
  return tx.moveCall({
    ...
    typeArguments: typeArgs,
    arguments: [obj(tx, args.dca), pure(tx, args.newDelegatee, `address`)],
  });
}
...
export function addExecutorReward(
  ...
  return tx.moveCall({
    ...
    typeArguments: typeArgs,
    arguments: [obj(tx, args.dca), obj(tx, args.rewardFunds)],
  });
}
