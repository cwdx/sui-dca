...
export function isTermsVersion(type: string): boolean {
  ...
  return (
    type ===
    `${getTypeOrigin("dca", "terms::TermsVersion")}::terms::TermsVersion`
  );
}
...
export class TermsVersion implements StructClass {
  ...
  static reified(): TermsVersionReified {
    ...
    return {
      ...
      fromFields: (fields: Record<string, any>) =>
        TermsVersion.fromFields(fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        TermsVersion.fromFieldsWithTypes(item),
      fromBcs: (data: Uint8Array) =>
        TermsVersion.fromFields(reifiedBcs.parse(data)),
      bcs: reifiedBcs,
      ...
      fromSuiParsedData: (content: SuiParsedData) =>
        TermsVersion.fromSuiParsedData(content),
      fromSuiObjectData: (content: SuiObjectData) =>
        TermsVersion.fromSuiObjectData(content),
      fetch: async (client: SupportedSuiClient, id: string) =>
        TermsVersion.fetch(client, id),
  ...
  private static cachedBcs: ReturnType<
    typeof TermsVersion.instantiateBcs
  > | null = null;
  ...
  static fromSuiParsedData(content: SuiParsedData): TermsVersion {
    ...
    if (!isTermsVersion(content.type)) {
      throw new Error(
        `object at ${(content.fields as any).id} is not a TermsVersion object`,
      );
    }
...
export function isTermsRegistry(type: string): boolean {
  ...
  return (
    type ===
    `${getTypeOrigin("dca", "terms::TermsRegistry")}::terms::TermsRegistry`
  );
}
...
export class TermsRegistry implements StructClass {
  ...
  readonly $typeArgs: [];
  readonly $isPhantom: typeof TermsRegistry.$isPhantom =
    TermsRegistry.$isPhantom;
  ...
  static reified(): TermsRegistryReified {
    ...
    return {
      ...
      reifiedTypeArgs: [],
      fromFields: (fields: Record<string, any>) =>
        TermsRegistry.fromFields(fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        TermsRegistry.fromFieldsWithTypes(item),
      fromBcs: (data: Uint8Array) =>
        TermsRegistry.fromFields(reifiedBcs.parse(data)),
      bcs: reifiedBcs,
      fromJSONField: (field: any) => TermsRegistry.fromJSONField(field),
      fromJSON: (json: Record<string, any>) => TermsRegistry.fromJSON(json),
      fromSuiParsedData: (content: SuiParsedData) =>
        TermsRegistry.fromSuiParsedData(content),
      fromSuiObjectData: (content: SuiObjectData) =>
        TermsRegistry.fromSuiObjectData(content),
      fetch: async (client: SupportedSuiClient, id: string) =>
        TermsRegistry.fetch(client, id),
  ...
  private static cachedBcs: ReturnType<
    typeof TermsRegistry.instantiateBcs
  > | null = null;
  ...
  static fromFieldsWithTypes(item: FieldsWithTypes): TermsRegistry {
    ...
    return TermsRegistry.reified().new({
      ...
      currentBlobId: decodeFromFieldsWithTypes(
        vector("u8"),
        item.fields.current_blob_id,
      ),
      version: decodeFromFieldsWithTypes("u64", item.fields.version),
      minAcceptedVersion: decodeFromFieldsWithTypes(
        "u64",
        item.fields.min_accepted_version,
      ),
      history: decodeFromFieldsWithTypes(
        vector(TermsVersion.reified()),
        item.fields.history,
      ),
    });
  }
  ...
  toJSONField(): TermsRegistryJSONField {
    return {
      id: this.id,
      admin: this.admin,
      currentBlobId: fieldToJSON<Vector<"u8">>(
        `vector<u8>`,
        this.currentBlobId,
      ),
      version: this.version.toString(),
      minAcceptedVersion: this.minAcceptedVersion.toString(),
      history: fieldToJSON<Vector<TermsVersion>>(
        `vector<${TermsVersion.$typeName}>`,
        this.history,
      ),
    };
  }
  ...
  static fromSuiParsedData(content: SuiParsedData): TermsRegistry {
    ...
    if (!isTermsRegistry(content.type)) {
      throw new Error(
        `object at ${(content.fields as any).id} is not a TermsRegistry object`,
      );
    }
...
export class TermsRegistryCreatedEvent implements StructClass {
  ...
  static reified(): TermsRegistryCreatedEventReified {
    ...
    return {
      ...
      reifiedTypeArgs: [],
      fromFields: (fields: Record<string, any>) =>
        TermsRegistryCreatedEvent.fromFields(fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        TermsRegistryCreatedEvent.fromFieldsWithTypes(item),
      fromBcs: (data: Uint8Array) =>
        TermsRegistryCreatedEvent.fromFields(reifiedBcs.parse(data)),
      bcs: reifiedBcs,
      fromJSONField: (field: any) =>
        TermsRegistryCreatedEvent.fromJSONField(field),
      fromJSON: (json: Record<string, any>) =>
        TermsRegistryCreatedEvent.fromJSON(json),
      fromSuiParsedData: (content: SuiParsedData) =>
  ...
  private static cachedBcs: ReturnType<
    typeof TermsRegistryCreatedEvent.instantiateBcs
  > | null = null;
  ...
  > {
    if (!TermsRegistryCreatedEvent.cachedBcs) {
      TermsRegistryCreatedEvent.cachedBcs =
        TermsRegistryCreatedEvent.instantiateBcs();
    }
  ...
  static fromFieldsWithTypes(item: FieldsWithTypes): TermsRegistryCreatedEvent {
    ...
    return TermsRegistryCreatedEvent.reified().new({
      ...
      initialBlobId: decodeFromFieldsWithTypes(
        vector("u8"),
        item.fields.initial_blob_id,
      ),
    });
  }

  static fromBcs(data: Uint8Array): TermsRegistryCreatedEvent {
    return TermsRegistryCreatedEvent.fromFields(
      TermsRegistryCreatedEvent.bcs.parse(data),
    );
  }
  ...
  toJSONField(): TermsRegistryCreatedEventJSONField {
    return {
      ...
      initialBlobId: fieldToJSON<Vector<"u8">>(
        `vector<u8>`,
        this.initialBlobId,
      ),
    };
  ...
  static fromSuiObjectData(data: SuiObjectData): TermsRegistryCreatedEvent {
    if (data.bcs) {
      if (
        data.bcs.dataType !== "moveObject" ||
        !isTermsRegistryCreatedEvent(data.bcs.type)
      ) {
  ...
  static async fetch(
    client: SupportedSuiClient,
    id: string,
  ): Promise<TermsRegistryCreatedEvent> {
    const res = await fetchObjectBcs(client, id);
    if (!isTermsRegistryCreatedEvent(res.type)) {
      throw new Error(
        `object at id ${id} is not a TermsRegistryCreatedEvent object`,
      );
    }
...
export function isTermsUpdatedEvent(type: string): boolean {
  ...
  return (
    type ===
    `${getTypeOrigin("dca", "terms::TermsUpdatedEvent")}::terms::TermsUpdatedEvent`
  );
}
...
export type TermsUpdatedEventReified = Reified<
  TermsUpdatedEvent,
  TermsUpdatedEventFields
>;
...
export class TermsUpdatedEvent implements StructClass {
  ...
  readonly $typeName: typeof TermsUpdatedEvent.$typeName =
    TermsUpdatedEvent.$typeName;
  readonly $fullTypeName: `${string}::terms::TermsUpdatedEvent`;
  readonly $typeArgs: [];
  readonly $isPhantom: typeof TermsUpdatedEvent.$isPhantom =
    TermsUpdatedEvent.$isPhantom;
  ...
  static reified(): TermsUpdatedEventReified {
    ...
    return {
      ...
      reifiedTypeArgs: [],
      fromFields: (fields: Record<string, any>) =>
        TermsUpdatedEvent.fromFields(fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        TermsUpdatedEvent.fromFieldsWithTypes(item),
      fromBcs: (data: Uint8Array) =>
        TermsUpdatedEvent.fromFields(reifiedBcs.parse(data)),
      bcs: reifiedBcs,
      ...
      fromSuiParsedData: (content: SuiParsedData) =>
        TermsUpdatedEvent.fromSuiParsedData(content),
      fromSuiObjectData: (content: SuiObjectData) =>
        TermsUpdatedEvent.fromSuiObjectData(content),
      fetch: async (client: SupportedSuiClient, id: string) =>
        TermsUpdatedEvent.fetch(client, id),
  ...
  private static cachedBcs: ReturnType<
    typeof TermsUpdatedEvent.instantiateBcs
  > | null = null;
  ...
  static fromFieldsWithTypes(item: FieldsWithTypes): TermsUpdatedEvent {
    ...
    return TermsUpdatedEvent.reified().new({
      ...
      newBlobId: decodeFromFieldsWithTypes(
        vector("u8"),
        item.fields.new_blob_id,
      ),
      timestamp: decodeFromFieldsWithTypes("u64", item.fields.timestamp),
    });
  }
  ...
  static fromSuiParsedData(content: SuiParsedData): TermsUpdatedEvent {
    ...
    if (!isTermsUpdatedEvent(content.type)) {
      throw new Error(
        `object at ${(content.fields as any).id} is not a TermsUpdatedEvent object`,
      );
    }
  ...
  static fromSuiObjectData(data: SuiObjectData): TermsUpdatedEvent {
    if (data.bcs) {
      if (
        data.bcs.dataType !== "moveObject" ||
        !isTermsUpdatedEvent(data.bcs.type)
      ) {
...
export class MinVersionUpdatedEvent implements StructClass {
  ...
  readonly $typeName: typeof MinVersionUpdatedEvent.$typeName =
    MinVersionUpdatedEvent.$typeName;
  readonly $fullTypeName: `${string}::terms::MinVersionUpdatedEvent`;
  readonly $typeArgs: [];
  readonly $isPhantom: typeof MinVersionUpdatedEvent.$isPhantom =
    MinVersionUpdatedEvent.$isPhantom;
  ...
  static reified(): MinVersionUpdatedEventReified {
    ...
    return {
      ...
      reifiedTypeArgs: [],
      fromFields: (fields: Record<string, any>) =>
        MinVersionUpdatedEvent.fromFields(fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        MinVersionUpdatedEvent.fromFieldsWithTypes(item),
      fromBcs: (data: Uint8Array) =>
        MinVersionUpdatedEvent.fromFields(reifiedBcs.parse(data)),
      bcs: reifiedBcs,
      fromJSONField: (field: any) =>
        MinVersionUpdatedEvent.fromJSONField(field),
      fromJSON: (json: Record<string, any>) =>
        MinVersionUpdatedEvent.fromJSON(json),
      fromSuiParsedData: (content: SuiParsedData) =>
  ...
  private static cachedBcs: ReturnType<
    typeof MinVersionUpdatedEvent.instantiateBcs
  > | null = null;

  static get bcs(): ReturnType<typeof MinVersionUpdatedEvent.instantiateBcs> {
    if (!MinVersionUpdatedEvent.cachedBcs) {
      MinVersionUpdatedEvent.cachedBcs =
        MinVersionUpdatedEvent.instantiateBcs();
    }
  ...
  static fromFieldsWithTypes(item: FieldsWithTypes): MinVersionUpdatedEvent {
    ...
    return MinVersionUpdatedEvent.reified().new({
      ...
      oldMinVersion: decodeFromFieldsWithTypes(
        "u64",
        item.fields.old_min_version,
      ),
      newMinVersion: decodeFromFieldsWithTypes(
        "u64",
        item.fields.new_min_version,
      ),
    });
  }

  static fromBcs(data: Uint8Array): MinVersionUpdatedEvent {
    return MinVersionUpdatedEvent.fromFields(
      MinVersionUpdatedEvent.bcs.parse(data),
    );
  }
  ...
  static fromSuiObjectData(data: SuiObjectData): MinVersionUpdatedEvent {
    if (data.bcs) {
      if (
        data.bcs.dataType !== "moveObject" ||
        !isMinVersionUpdatedEvent(data.bcs.type)
      ) {
  ...
  static async fetch(
    client: SupportedSuiClient,
    id: string,
  ): Promise<MinVersionUpdatedEvent> {
    const res = await fetchObjectBcs(client, id);
    if (!isMinVersionUpdatedEvent(res.type)) {
      throw new Error(
        `object at id ${id} is not a MinVersionUpdatedEvent object`,
      );
    }
