module cetus::config_script {
    ...
    public entry fun delete_fee_tier(arg_0: &mut GlobalConfig, arg_1: u32, arg_2: &TxContext) {
        abort (0)
    }

    public entry fun set_roles(
        arg_0: &AdminCap,
        arg_1: &mut GlobalConfig,
        arg_2: address,
        arg_3: u128,
    ) {
        abort (0)
    ...
    public entry fun remove_member(arg_0: &AdminCap, arg_1: &mut GlobalConfig, arg_2: address) {
        abort (0)
    }
