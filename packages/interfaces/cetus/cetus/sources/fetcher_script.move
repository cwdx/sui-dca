module cetus::fetcher_script {
    ...
    public entry fun fetch_ticks<Ty0, Ty1>(arg_0: &Pool<Ty0, Ty1>, arg_1: vector<u32>, arg_2: u64) {
        abort (0)
    }

    public entry fun fetch_positions<Ty0, Ty1>(
        arg_0: &Pool<Ty0, Ty1>,
        arg_1: vector<ID>,
        arg_2: u64,
    ) {
    ...
    public entry fun fetch_pools(arg_0: &Pools, arg_1: vector<ID>, arg_2: u64) {
        abort (0)
    }

    public entry fun calculate_swap_result<Ty0, Ty1>(
        arg_0: &Pool<Ty0, Ty1>,
        arg_1: bool,
        arg_2: bool,
        arg_3: u64,
    ...
    public entry fun fetch_position_rewards<Ty0, Ty1>(
        arg_0: &GlobalConfig,
        arg_1: &mut Pool<Ty0, Ty1>,
        arg_2: ID,
        arg_3: &Clock,
    ) {
        abort (0)
    ...
    public entry fun fetch_position_fees<Ty0, Ty1>(
        arg_0: &GlobalConfig,
        arg_1: &mut Pool<Ty0, Ty1>,
        arg_2: ID,
    ) {
    ...
    public entry fun fetch_position_points<Ty0, Ty1>(
        arg_0: &GlobalConfig,
        arg_1: &mut Pool<Ty0, Ty0>,
        arg_2: ID,
        arg_3: &Clock,
    ) {
        abort (0)
