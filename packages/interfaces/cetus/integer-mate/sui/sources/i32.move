module integer_mate::i32 {
    ...
    fun test_wrapping_sub() {
        ...
        assert!(
            as_u32(wrapping_sub(neg_from(1000000), neg_from(1))) == as_u32(neg_from(999999)),
            0,
        );
        ...
        assert!(
            as_u32(wrapping_sub(from(MAX_AS_U32), neg_from(1))) == as_u32(neg_from(MIN_AS_U32)),
            0,
        );
        assert!(
    ...
    fun test_sub() {
        ...
        assert!(
            as_u32(sub(neg_from(MIN_AS_U32), neg_from(1))) == as_u32(neg_from(MIN_AS_U32 - 1)),
            0,
        );
    }
