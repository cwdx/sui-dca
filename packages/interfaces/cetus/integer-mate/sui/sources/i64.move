module integer_mate::i64 {
    ...
    fun test_wrapping_sub() {
        ...
        assert!(
            as_u64(wrapping_sub(neg_from(1000000), neg_from(1))) == as_u64(neg_from(999999)),
            0,
        );
        ...
        assert!(
            as_u64(wrapping_sub(from(MAX_AS_U64), neg_from(1))) == as_u64(neg_from(MIN_AS_U64)),
            0,
        );
        assert!(
    ...
    fun test_sub() {
        ...
        assert!(
            as_u64(sub(neg_from(MIN_AS_U64), neg_from(1))) == as_u64(neg_from(MIN_AS_U64 - 1)),
            0,
        );
    }
