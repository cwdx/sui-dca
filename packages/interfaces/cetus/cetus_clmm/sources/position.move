...
module cetus_clmm::position {
    ...
    /// New `PositionManager`
    public(friend) fun new(_tick_spacing: u32, _ctx: &mut TxContext): PositionManager {
        abort 0
    }
    ...
    public fun borrow_position_info(_manager: &PositionManager, _position_id: ID): &PositionInfo {
        abort 0
    }
