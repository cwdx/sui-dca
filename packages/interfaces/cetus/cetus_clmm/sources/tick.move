...
module cetus_clmm::tick {
    ...
    public fun fetch_ticks(_manager: &TickManager, _start: vector<u32>, _limit: u64): vector<Tick> {
        abort 0
    }
    ...
    #[test_only]
    public fun copy_tick_with_default(_manager: &TickManager, _tick_idx: I32): Tick {
        abort 0
    }
