module cetus_clmm::clmm_math {
    ...
    fun test_get_liquidity_from_a() {
        ...
        let amount_a = 300000000000;
        assert!(
            get_liquidity_from_a(sqrt_price_0, sqrt_price_1, amount_a, false) == 6089108304263,
            0,
        );
    ...
    fun test_get_liquidity_from_b() {
        ...
        let amount_b = 300000000000;
        assert!(
            get_liquidity_from_b(sqrt_price_0, sqrt_price_1, amount_b, false) == 5795050123394,
            0,
        );
