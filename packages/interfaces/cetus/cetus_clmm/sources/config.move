...
module cetus_clmm::config {
    ...
    ///     - config: The global config
    ///     - tick_spacing: The tick spacing
    public fun delete_fee_tier(_config: &mut GlobalConfig, _tick_spacing: u32, _ctx: &TxContext) {
        abort 0
    }
    ...
    public fun get_fee_rate(_tick_spacing: u32, _global_config: &GlobalConfig): u64 {
        abort 0
    }
