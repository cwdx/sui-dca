module aftermath_router::router {
    ...
    struct DeepBookRouterWrapper has key, store {
        id: UID,
    ...
    public fun swap_exact_base_for_quote<Ty0, Ty1, Ty2>(
        arg_0: &mut DeepBookRouterWrapper,
    ...
    public fun swap_exact_quote_for_base<Ty0, Ty1, Ty2>(
        arg_0: &mut DeepBookRouterWrapper,
        arg_1: &mut RouterSwapCap<Ty0>,
        arg_2: &mut Pool<Ty1, Ty2>,
        arg_3: Coin<Ty2>,
