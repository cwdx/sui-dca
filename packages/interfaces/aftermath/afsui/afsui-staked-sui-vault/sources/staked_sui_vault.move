...
module lsd::staked_sui_vault {
    ...
    struct CreateStakedSuiVaultCap has key, store {
        id: sui::object::UID,
    }
    ...
    public fun total_sui_amount(_arg_0: &lsd::staked_sui_vault::StakedSuiVault): u64 {
        abort 0
    }

    public fun total_rewards_amount(_arg_0: &lsd::staked_sui_vault::StakedSuiVault): u64 {
        abort 0
    }
