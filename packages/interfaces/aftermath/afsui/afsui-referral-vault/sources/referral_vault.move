...
module afsui_referral_vault::referral_vault {
    ...
    public fun has_referrer(
        _arg_0: &afsui_referral_vault::referral_vault::ReferralVault,
        _arg_1: address,
    ): bool {
        abort 0
    }
    ...
    public fun update_referrer_address(
        _arg_0: &mut afsui_referral_vault::referral_vault::ReferralVault,
        _arg_1: address,
    ...
    public fun assert_version(_arg_0: &afsui_referral_vault::referral_vault::ReferralVault) {
        abort 0
    }
}
