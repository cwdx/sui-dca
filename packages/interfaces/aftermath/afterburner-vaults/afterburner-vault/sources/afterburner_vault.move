...
module afterburner_vaults::afterburner_vault {
    ...
    struct OneTimeAdminCap<phantom T0> has key, store {
        id: sui::object::UID,
        afterburner_vault_id: sui::object::ID,
    }

    struct AfterburnerVault<phantom T0> has key, store {
        id: sui::object::UID,
    ...
    public fun new<T0>(
        ...
        afterburner_vaults::afterburner_vault::AfterburnerVault<T0>,
        afterburner_vaults::afterburner_vault::OwnerCap,
    ) {
        abort 0
    }
