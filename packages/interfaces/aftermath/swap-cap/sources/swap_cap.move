module aftermath_swap_cap::swap_cap {
    ...
    fun emit_swap_completed_event(
        arg_0: SwapMetadata,
        arg_1: SwapMetadata,
        arg_2: RouterFeeMetadata,
        arg_3: Option<address>,
        arg_4: &TxContext,
    ) {
        abort (0)
    }

    public fun obtain_router_cap<Ty0, Ty1>(
        arg_0: Coin<Ty0>,
        arg_1: u64,
        arg_2: Option<address>,
        arg_3: Option<address>,
        arg_4: Option<u64>,
    ): RouterSwapCap<Ty0> {
        abort (0)
    ...
    public fun initiate_path<Ty0>(
        arg_0: &mut RouterSwapCap<Ty0>,
        arg_1: u64,
        arg_2: &mut TxContext,
    ): Coin<Ty0> {
        abort (0)
    ...
    public fun update_path_metadata<Ty0, Ty1>(
        arg_0: &UID,
        arg_1: &mut RouterSwapCap<Ty0>,
        arg_2: u64,
    ) {
        abort (0)
    }

    public fun pay_protocol_and_router_fee<Ty0, Ty1, Ty2>(
        arg_0: &UID,
        arg_1: &mut RouterSwapCap<Ty0>,
        arg_2: &mut Coin<Ty1>,
        arg_3: &ProtocolFeeVault,
        arg_4: &mut Treasury,
        arg_5: &mut InsuranceFund,
        arg_6: &ReferralVault,
        arg_7: &mut TxContext,
    ) {
        abort (0)
    ...
    public fun return_router_cap<Ty0, Ty1>(
        arg_0: RouterSwapCap<Ty0>,
        arg_1: &mut Coin<Ty1>,
    ...
    public fun return_router_cap_already_payed_fee<Ty0>(
        arg_0: RouterSwapCap<Ty0>,
        arg_1: &mut TxContext,
    ) {
        abort (0)
    ...
    fun transfer_router_fee<Ty0>(
        arg_0: &mut Coin<Ty0>,
        arg_1: RouterFeeMetadata,
        arg_2: &mut TxContext,
    ) {
        abort (0)
    }

    fun pay_protocol_and_router_fee_inner<Ty0, Ty1>(
        arg_0: &mut RouterSwapCap<Ty0>,
        arg_1: &mut Coin<Ty1>,
        arg_2: &ProtocolFeeVault,
        arg_3: &mut Treasury,
