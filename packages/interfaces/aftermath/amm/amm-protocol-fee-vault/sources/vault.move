...
module protocol_fee_vault::vault {
    ...
    struct ProtocolFeeVault has key, store {
        id: sui::object::UID,
        version: u64,
        dev_wallet: address,
    ...
    public fun transfer(_arg_0: protocol_fee_vault::vault::ChangeFeeCap, _arg_1: address) {
        abort 0
    }

    fun init(_arg_0: &mut sui::tx_context::TxContext) {
        abort 0
    }

    public fun total_protocol_fee(_arg_0: &protocol_fee_vault::vault::ProtocolFeeVault): u64 {
        abort 0
    }

    public fun treasury_fee(_arg_0: &protocol_fee_vault::vault::ProtocolFeeVault): u64 {
        abort 0
    }

    public fun insurance_fund_fee(_arg_0: &protocol_fee_vault::vault::ProtocolFeeVault): u64 {
        abort 0
    }

    public fun dev_wallet_fee(_arg_0: &protocol_fee_vault::vault::ProtocolFeeVault): u64 {
        abort 0
    }

    public fun referee_discount(_arg_0: &protocol_fee_vault::vault::ProtocolFeeVault): u64 {
        abort 0
    }
    ...
    public fun assert_version(_arg_0: &protocol_fee_vault::vault::ProtocolFeeVault) {
        abort 0
    }
}
