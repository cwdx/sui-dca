...
module insurance_fund::insurance_fund {
    ...
    public fun transfer(_arg_0: insurance_fund::insurance_fund::AdminCap, _arg_1: address) {
        abort 0
    }
    ...
    public fun balance_of<T0>(_arg_0: &mut insurance_fund::insurance_fund::InsuranceFund): u64 {
        abort 0
    }
    ...
    public fun assert_version(_arg_0: &insurance_fund::insurance_fund::InsuranceFund) {
        abort 0
    }
}
