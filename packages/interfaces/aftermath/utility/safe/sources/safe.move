...
module safe::safe {
    ...
    public fun borrow_obj<T0>(_arg_0: &safe::safe::Safe<T0>): &T0 {
        abort 0
    }

    public fun assert_authorization<T0>(_arg_0: &safe::safe::Safe<T0>, _arg_1: sui::object::ID) {
        abort 0
    }
    ...
    public fun revoke_auth<T0>(_arg_0: &mut safe::safe::Safe<T0>, _arg_1: &safe::safe::OwnerCap) {
        abort 0
    }
}
