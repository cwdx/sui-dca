...
export function assertVersion(tx: Transaction, config: TransactionObjectInput): TransactionResult {
  return tx.moveCall({
...
export function feeBps(tx: Transaction, config: TransactionObjectInput): TransactionResult {
  return tx.moveCall({
...
export function maxSlippageBps(tx: Transaction, config: TransactionObjectInput): TransactionResult {
  return tx.moveCall({
...
export function treasury(tx: Transaction, config: TransactionObjectInput): TransactionResult {
  return tx.moveCall({
...
export function isPaused(tx: Transaction, config: TransactionObjectInput): TransactionResult {
  return tx.moveCall({
...
export function version(tx: Transaction, config: TransactionObjectInput): TransactionResult {
  return tx.moveCall({
 ...
 */
export function isExecutorAllowed(tx: Transaction, args: IsExecutorAllowedArgs): TransactionResult {
  return tx.moveCall({
...
export function suiBalance(tx: Transaction, feeTracker: TransactionObjectInput): TransactionResult {
  return tx.moveCall({
...
export function createSnapshot(tx: Transaction, config: TransactionObjectInput): TransactionResult {
  return tx.moveCall({
...
export function depositSui(tx: Transaction, args: DepositSuiArgs): TransactionResult {
  return tx.moveCall({
...
export function setFeeBps(tx: Transaction, args: SetFeeBpsArgs): TransactionResult {
  return tx.moveCall({
...
export function setMaxSlippageBps(tx: Transaction, args: SetMaxSlippageBpsArgs): TransactionResult {
  return tx.moveCall({
...
export function setTreasury(tx: Transaction, args: SetTreasuryArgs): TransactionResult {
  return tx.moveCall({
...
export function setPaused(tx: Transaction, args: SetPausedArgs): TransactionResult {
  return tx.moveCall({
...
export function addExecutor(tx: Transaction, args: AddExecutorArgs): TransactionResult {
  return tx.moveCall({
...
export function removeExecutor(tx: Transaction, args: RemoveExecutorArgs): TransactionResult {
  return tx.moveCall({
...
export function withdrawSui(tx: Transaction, args: WithdrawSuiArgs): TransactionResult {
  return tx.moveCall({
...
export function createPriceFeedRegistry(
  ...
  return tx.moveCall({
    ...
    arguments: [
      obj(tx, args.cap),
      pure(tx, args.suiUsdFeedId, `vector<u8>`),
    ],
  })
}
...
export function setSuiUsdFeed(tx: Transaction, args: SetSuiUsdFeedArgs): TransactionResult {
  return tx.moveCall({
...
export function requiresRouting(tx: Transaction, feed: TransactionObjectInput): TransactionResult {
  return tx.moveCall({
...
export function feedId(tx: Transaction, feed: TransactionObjectInput): TransactionResult {
  return tx.moveCall({
...
export function quoteCurrency(tx: Transaction, feed: TransactionObjectInput): TransactionResult {
  return tx.moveCall({
...
export function suiUsdFeedId(tx: Transaction, registry: TransactionObjectInput): TransactionResult {
  return tx.moveCall({
