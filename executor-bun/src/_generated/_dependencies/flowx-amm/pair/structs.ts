...
export function isLP(type: string): boolean {
  ...
  return type.startsWith(`${getTypeOrigin('flowx-amm', 'pair::LP')}::pair::LP` + '<')
}
...
export type LPReified<BASE extends PhantomTypeArgument, QUOTE extends PhantomTypeArgument> =
  Reified<LP<BASE, QUOTE>, LPFields<BASE, QUOTE>>

export type LPJSONField<BASE extends PhantomTypeArgument, QUOTE extends PhantomTypeArgument> = {
  dummyField: boolean
}

export type LPJSON<BASE extends PhantomTypeArgument, QUOTE extends PhantomTypeArgument> = {
  $typeName: typeof LP.$typeName
  $typeArgs: [PhantomToTypeStr<BASE>, PhantomToTypeStr<QUOTE>]
} & LPJSONField<BASE, QUOTE>

export class LP<BASE extends PhantomTypeArgument, QUOTE extends PhantomTypeArgument>
  implements StructClass
{
  __StructClass = true as const

  static readonly $typeName: `${string}::pair::LP` = `${
    getTypeOrigin('flowx-amm', 'pair::LP')
  }::pair::LP` as const
  static readonly $numTypeParams = 2
  static readonly $isPhantom = [true, true] as const

  readonly $typeName: typeof LP.$typeName = LP.$typeName
  readonly $fullTypeName: `${string}::pair::LP<${PhantomToTypeStr<BASE>}, ${PhantomToTypeStr<
    QUOTE
  >}>`
  ...
  >(
    ...
    return {
      ...
      fromFields: (fields: Record<string, any>) => LP.fromFields([BASE, QUOTE], fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) => LP.fromFieldsWithTypes([BASE, QUOTE], item),
      fromBcs: (data: Uint8Array) => LP.fromFields([BASE, QUOTE], reifiedBcs.parse(data)),
      bcs: reifiedBcs,
      fromJSONField: (field: any) => LP.fromJSONField([BASE, QUOTE], field),
      fromJSON: (json: Record<string, any>) => LP.fromJSON([BASE, QUOTE], json),
      fromSuiParsedData: (content: SuiParsedData) => LP.fromSuiParsedData([BASE, QUOTE], content),
      fromSuiObjectData: (content: SuiObjectData) => LP.fromSuiObjectData([BASE, QUOTE], content),
      fetch: async (client: SupportedSuiClient, id: string) => LP.fetch(client, [BASE, QUOTE], id),
      new: (fields: LPFields<ToPhantomTypeArgument<BASE>, ToPhantomTypeArgument<QUOTE>>) => {
...
export type PairMetadataJSON<BASE extends PhantomTypeArgument, QUOTE extends PhantomTypeArgument> =
  & {
...
export class PairMetadata<BASE extends PhantomTypeArgument, QUOTE extends PhantomTypeArgument>
  implements StructClass
{
  __StructClass = true as const

  static readonly $typeName: `${string}::pair::PairMetadata` = `${
    getTypeOrigin('flowx-amm', 'pair::PairMetadata')
  }::pair::PairMetadata` as const
  static readonly $numTypeParams = 2
  static readonly $isPhantom = [true, true] as const

  readonly $typeName: typeof PairMetadata.$typeName = PairMetadata.$typeName
  readonly $fullTypeName: `${string}::pair::PairMetadata<${PhantomToTypeStr<
    BASE
  >}, ${PhantomToTypeStr<QUOTE>}>`
  readonly $typeArgs: [PhantomToTypeStr<BASE>, PhantomToTypeStr<QUOTE>]
  ...
  >(
    ...
    return {
      ...
      reifiedTypeArgs: [BASE, QUOTE],
      fromFields: (fields: Record<string, any>) => PairMetadata.fromFields([BASE, QUOTE], fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        PairMetadata.fromFieldsWithTypes([BASE, QUOTE], item),
      fromBcs: (data: Uint8Array) => PairMetadata.fromFields([BASE, QUOTE], reifiedBcs.parse(data)),
      bcs: reifiedBcs,
      fromJSONField: (field: any) => PairMetadata.fromJSONField([BASE, QUOTE], field),
      fromJSON: (json: Record<string, any>) => PairMetadata.fromJSON([BASE, QUOTE], json),
      ...
      new: (
        ...
        return new PairMetadata([extractType(BASE), extractType(QUOTE)], fields)
      },
      kind: 'StructClassReified',
    }
  }
  ...
  >(
    ...
    ToTypeStr<PairMetadata<ToPhantomTypeArgument<BASE>, ToPhantomTypeArgument<QUOTE>>>
  > {
  ...
  private static cachedBcs: ReturnType<typeof PairMetadata.instantiateBcs> | null = null
  ...
  >(
    ...
    return PairMetadata.reified(typeArgs[0], typeArgs[1]).new({
      ...
      reserveX: decodeFromFieldsWithTypes(Coin.reified(typeArgs[0]), item.fields.reserve_x),
      reserveY: decodeFromFieldsWithTypes(Coin.reified(typeArgs[1]), item.fields.reserve_y),
  ...
  >(
    ...
    if (data.bcs) {
      if (data.bcs.dataType !== 'moveObject' || !isPairMetadata(data.bcs.type)) {
...
export function isLiquidityAdded(type: string): boolean {
  type = compressSuiType(type)
  return type === `${getTypeOrigin('flowx-amm', 'pair::LiquidityAdded')}::pair::LiquidityAdded`
}
...
export type LiquidityAddedReified = Reified<LiquidityAdded, LiquidityAddedFields>
...
export class LiquidityAdded implements StructClass {
  ...
  static readonly $typeName: `${string}::pair::LiquidityAdded` = `${
    getTypeOrigin('flowx-amm', 'pair::LiquidityAdded')
  }::pair::LiquidityAdded` as const
  static readonly $numTypeParams = 0
  static readonly $isPhantom = [] as const

  readonly $typeName: typeof LiquidityAdded.$typeName = LiquidityAdded.$typeName
  readonly $fullTypeName: `${string}::pair::LiquidityAdded`
  readonly $typeArgs: []
  readonly $isPhantom: typeof LiquidityAdded.$isPhantom = LiquidityAdded.$isPhantom
  ...
  static reified(): LiquidityAddedReified {
    ...
    return {
      ...
      reifiedTypeArgs: [],
      fromFields: (fields: Record<string, any>) => LiquidityAdded.fromFields(fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) => LiquidityAdded.fromFieldsWithTypes(item),
      fromBcs: (data: Uint8Array) => LiquidityAdded.fromFields(reifiedBcs.parse(data)),
      bcs: reifiedBcs,
      fromJSONField: (field: any) => LiquidityAdded.fromJSONField(field),
      fromJSON: (json: Record<string, any>) => LiquidityAdded.fromJSON(json),
      fromSuiParsedData: (content: SuiParsedData) => LiquidityAdded.fromSuiParsedData(content),
      fromSuiObjectData: (content: SuiObjectData) => LiquidityAdded.fromSuiObjectData(content),
      fetch: async (client: SupportedSuiClient, id: string) => LiquidityAdded.fetch(client, id),
  ...
  private static cachedBcs: ReturnType<typeof LiquidityAdded.instantiateBcs> | null = null
  ...
  static fromSuiObjectData(data: SuiObjectData): LiquidityAdded {
    if (data.bcs) {
      if (data.bcs.dataType !== 'moveObject' || !isLiquidityAdded(data.bcs.type)) {
  ...
  static async fetch(client: SupportedSuiClient, id: string): Promise<LiquidityAdded> {
    const res = await fetchObjectBcs(client, id)
...
export function isLiquidityRemoved(type: string): boolean {
  type = compressSuiType(type)
  return type === `${getTypeOrigin('flowx-amm', 'pair::LiquidityRemoved')}::pair::LiquidityRemoved`
}
...
export class LiquidityRemoved implements StructClass {
  ...
  static readonly $typeName: `${string}::pair::LiquidityRemoved` = `${
    getTypeOrigin('flowx-amm', 'pair::LiquidityRemoved')
  }::pair::LiquidityRemoved` as const
  static readonly $numTypeParams = 0
  static readonly $isPhantom = [] as const

  readonly $typeName: typeof LiquidityRemoved.$typeName = LiquidityRemoved.$typeName
  readonly $fullTypeName: `${string}::pair::LiquidityRemoved`
  readonly $typeArgs: []
  readonly $isPhantom: typeof LiquidityRemoved.$isPhantom = LiquidityRemoved.$isPhantom
...
export function isSwapped(type: string): boolean {
  type = compressSuiType(type)
  return type === `${getTypeOrigin('flowx-amm', 'pair::Swapped')}::pair::Swapped`
}
...
export class Swapped implements StructClass {
  ...
  static readonly $typeName: `${string}::pair::Swapped` = `${
    getTypeOrigin('flowx-amm', 'pair::Swapped')
  ...
  static reified(): SwappedReified {
    ...
    return {
      ...
      fromFieldsWithTypes: (item: FieldsWithTypes) => Swapped.fromFieldsWithTypes(item),
      ...
      fromSuiParsedData: (content: SuiParsedData) => Swapped.fromSuiParsedData(content),
      fromSuiObjectData: (content: SuiObjectData) => Swapped.fromSuiObjectData(content),
      fetch: async (client: SupportedSuiClient, id: string) => Swapped.fetch(client, id),
  ...
  private static cachedBcs: ReturnType<typeof Swapped.instantiateBcs> | null = null
