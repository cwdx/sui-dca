...
export function isAdminCap(type: string): boolean {
  ...
  return type === `${getTypeOrigin('dca', 'config::AdminCap')}::config::AdminCap`
}
...
export class AdminCap implements StructClass {
  ...
  static readonly $typeName: `${string}::config::AdminCap` = `${
    getTypeOrigin('dca', 'config::AdminCap')
...
export function isGlobalConfig(type: string): boolean {
  type = compressSuiType(type)
  return type === `${getTypeOrigin('dca', 'config::GlobalConfig')}::config::GlobalConfig`
}
...
export class GlobalConfig implements StructClass {
  ...
  static readonly $typeName: `${string}::config::GlobalConfig` = `${
    getTypeOrigin('dca', 'config::GlobalConfig')
  ...
  static fromFields(fields: Record<string, any>): GlobalConfig {
    return GlobalConfig.reified().new({
      ...
      maxOrdersPerAccount: decodeFromFields('u64', fields.max_orders_per_account),
      ...
      executorWhitelistEnabled: decodeFromFields('bool', fields.executor_whitelist_enabled),
      whitelistedExecutors: decodeFromFields(vector('address'), fields.whitelisted_executors),
    })
  }
  ...
  static fromFieldsWithTypes(item: FieldsWithTypes): GlobalConfig {
    ...
    return GlobalConfig.reified().new({
      ...
      maxOrdersPerAccount: decodeFromFieldsWithTypes('u64', item.fields.max_orders_per_account),
      minFundingPerTrade: decodeFromFieldsWithTypes('u64', item.fields.min_funding_per_trade),
      defaultSlippageBps: decodeFromFieldsWithTypes('u64', item.fields.default_slippage_bps),
      maxSlippageBps: decodeFromFieldsWithTypes('u64', item.fields.max_slippage_bps),
      minIntervalSeconds: decodeFromFieldsWithTypes('u64', item.fields.min_interval_seconds),
  ...
  static fromJSONField(field: any): GlobalConfig {
    return GlobalConfig.reified().new({
      ...
      maxOrdersPerAccount: decodeFromJSONField('u64', field.maxOrdersPerAccount),
      ...
      executorWhitelistEnabled: decodeFromJSONField('bool', field.executorWhitelistEnabled),
      whitelistedExecutors: decodeFromJSONField(vector('address'), field.whitelistedExecutors),
    })
  }
...
export function isFeeTracker(type: string): boolean {
  type = compressSuiType(type)
  return type === `${getTypeOrigin('dca', 'config::FeeTracker')}::config::FeeTracker`
}
...
export class FeeTracker implements StructClass {
  ...
  static readonly $typeName: `${string}::config::FeeTracker` = `${
    getTypeOrigin('dca', 'config::FeeTracker')
  ...
  static reified(): FeeTrackerReified {
    ...
    return {
      ...
      reifiedTypeArgs: [],
      fromFields: (fields: Record<string, any>) => FeeTracker.fromFields(fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) => FeeTracker.fromFieldsWithTypes(item),
      fromBcs: (data: Uint8Array) => FeeTracker.fromFields(reifiedBcs.parse(data)),
      bcs: reifiedBcs,
      fromJSONField: (field: any) => FeeTracker.fromJSONField(field),
      fromJSON: (json: Record<string, any>) => FeeTracker.fromJSON(json),
      fromSuiParsedData: (content: SuiParsedData) => FeeTracker.fromSuiParsedData(content),
      fromSuiObjectData: (content: SuiObjectData) => FeeTracker.fromSuiObjectData(content),
      fetch: async (client: SupportedSuiClient, id: string) => FeeTracker.fetch(client, id),
  ...
  private static cachedBcs: ReturnType<typeof FeeTracker.instantiateBcs> | null = null
  ...
  static fromFields(fields: Record<string, any>): FeeTracker {
    return FeeTracker.reified().new({
      ...
      suiBalance: decodeFromFields(Balance.reified(phantom(SUI.reified())), fields.sui_balance),
    })
  }
  ...
  static fromFieldsWithTypes(item: FieldsWithTypes): FeeTracker {
    ...
    return FeeTracker.reified().new({
      id: decodeFromFieldsWithTypes(UID.reified(), item.fields.id),
      admin: decodeFromFieldsWithTypes(ID.reified(), item.fields.admin),
      totalSuiCollected: decodeFromFieldsWithTypes('u64', item.fields.total_sui_collected),
  ...
  static fromJSONField(field: any): FeeTracker {
    return FeeTracker.reified().new({
      ...
      suiBalance: decodeFromJSONField(Balance.reified(phantom(SUI.reified())), field.suiBalance),
    })
  }
  ...
  static fromSuiParsedData(content: SuiParsedData): FeeTracker {
    ...
    if (!isFeeTracker(content.type)) {
      throw new Error(`object at ${(content.fields as any).id} is not a FeeTracker object`)
    }
  ...
  static async fetch(client: SupportedSuiClient, id: string): Promise<FeeTracker> {
    const res = await fetchObjectBcs(client, id)
...
export function isPriceFeed(type: string): boolean {
  type = compressSuiType(type)
  return type === `${getTypeOrigin('dca', 'config::PriceFeed')}::config::PriceFeed`
}
...
export class PriceFeed implements StructClass {
  ...
  static readonly $typeName: `${string}::config::PriceFeed` = `${
    getTypeOrigin('dca', 'config::PriceFeed')
  ...
  static fromFieldsWithTypes(item: FieldsWithTypes): PriceFeed {
    ...
    return PriceFeed.reified().new({
      ...
      quoteCurrency: decodeFromFieldsWithTypes('u8', item.fields.quote_currency),
...
export function isPriceFeedRegistry(type: string): boolean {
  type = compressSuiType(type)
  return type === `${getTypeOrigin('dca', 'config::PriceFeedRegistry')}::config::PriceFeedRegistry`
}
...
export type PriceFeedRegistryReified = Reified<PriceFeedRegistry, PriceFeedRegistryFields>
...
export class PriceFeedRegistry implements StructClass {
  ...
  static readonly $typeName: `${string}::config::PriceFeedRegistry` = `${
    getTypeOrigin('dca', 'config::PriceFeedRegistry')
  }::config::PriceFeedRegistry` as const
  static readonly $numTypeParams = 0
  static readonly $isPhantom = [] as const

  readonly $typeName: typeof PriceFeedRegistry.$typeName = PriceFeedRegistry.$typeName
  readonly $fullTypeName: `${string}::config::PriceFeedRegistry`
  readonly $typeArgs: []
  readonly $isPhantom: typeof PriceFeedRegistry.$isPhantom = PriceFeedRegistry.$isPhantom
  ...
  static reified(): PriceFeedRegistryReified {
    ...
    return {
      ...
      reifiedTypeArgs: [],
      fromFields: (fields: Record<string, any>) => PriceFeedRegistry.fromFields(fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) => PriceFeedRegistry.fromFieldsWithTypes(item),
      fromBcs: (data: Uint8Array) => PriceFeedRegistry.fromFields(reifiedBcs.parse(data)),
      bcs: reifiedBcs,
      ...
      fromSuiParsedData: (content: SuiParsedData) => PriceFeedRegistry.fromSuiParsedData(content),
      fromSuiObjectData: (content: SuiObjectData) => PriceFeedRegistry.fromSuiObjectData(content),
      fetch: async (client: SupportedSuiClient, id: string) => PriceFeedRegistry.fetch(client, id),
  ...
  private static cachedBcs: ReturnType<typeof PriceFeedRegistry.instantiateBcs> | null = null
  ...
  static fromFieldsWithTypes(item: FieldsWithTypes): PriceFeedRegistry {
    ...
    return PriceFeedRegistry.reified().new({
      ...
      suiUsdFeedId: decodeFromFieldsWithTypes(vector('u8'), item.fields.sui_usd_feed_id),
    })
  }
  ...
  static fromSuiParsedData(content: SuiParsedData): PriceFeedRegistry {
    ...
    if (!isPriceFeedRegistry(content.type)) {
      throw new Error(`object at ${(content.fields as any).id} is not a PriceFeedRegistry object`)
    }
  ...
  static fromSuiObjectData(data: SuiObjectData): PriceFeedRegistry {
    if (data.bcs) {
      if (data.bcs.dataType !== 'moveObject' || !isPriceFeedRegistry(data.bcs.type)) {
  ...
  static async fetch(client: SupportedSuiClient, id: string): Promise<PriceFeedRegistry> {
    const res = await fetchObjectBcs(client, id)
...
export function isConfigSnapshot(type: string): boolean {
  type = compressSuiType(type)
  return type === `${getTypeOrigin('dca', 'config::ConfigSnapshot')}::config::ConfigSnapshot`
}
...
export type ConfigSnapshotReified = Reified<ConfigSnapshot, ConfigSnapshotFields>
...
export class ConfigSnapshot implements StructClass {
  ...
  static readonly $typeName: `${string}::config::ConfigSnapshot` = `${
    getTypeOrigin('dca', 'config::ConfigSnapshot')
  }::config::ConfigSnapshot` as const
  static readonly $numTypeParams = 0
  static readonly $isPhantom = [] as const

  readonly $typeName: typeof ConfigSnapshot.$typeName = ConfigSnapshot.$typeName
  readonly $fullTypeName: `${string}::config::ConfigSnapshot`
  readonly $typeArgs: []
  readonly $isPhantom: typeof ConfigSnapshot.$isPhantom = ConfigSnapshot.$isPhantom
  ...
  static reified(): ConfigSnapshotReified {
    ...
    return {
      ...
      reifiedTypeArgs: [],
      fromFields: (fields: Record<string, any>) => ConfigSnapshot.fromFields(fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) => ConfigSnapshot.fromFieldsWithTypes(item),
      fromBcs: (data: Uint8Array) => ConfigSnapshot.fromFields(reifiedBcs.parse(data)),
      bcs: reifiedBcs,
      fromJSONField: (field: any) => ConfigSnapshot.fromJSONField(field),
      fromJSON: (json: Record<string, any>) => ConfigSnapshot.fromJSON(json),
      fromSuiParsedData: (content: SuiParsedData) => ConfigSnapshot.fromSuiParsedData(content),
      fromSuiObjectData: (content: SuiObjectData) => ConfigSnapshot.fromSuiObjectData(content),
      fetch: async (client: SupportedSuiClient, id: string) => ConfigSnapshot.fetch(client, id),
  ...
  private static cachedBcs: ReturnType<typeof ConfigSnapshot.instantiateBcs> | null = null
  ...
  static fromSuiParsedData(content: SuiParsedData): ConfigSnapshot {
    ...
    if (!isConfigSnapshot(content.type)) {
      throw new Error(`object at ${(content.fields as any).id} is not a ConfigSnapshot object`)
    }
  ...
  static fromSuiObjectData(data: SuiObjectData): ConfigSnapshot {
    if (data.bcs) {
      if (data.bcs.dataType !== 'moveObject' || !isConfigSnapshot(data.bcs.type)) {
  ...
  static async fetch(client: SupportedSuiClient, id: string): Promise<ConfigSnapshot> {
    const res = await fetchObjectBcs(client, id)
...
export type ConfigCreatedEventReified = Reified<ConfigCreatedEvent, ConfigCreatedEventFields>
...
export class ConfigCreatedEvent implements StructClass {
  ...
  static readonly $typeName: `${string}::config::ConfigCreatedEvent` = `${
    getTypeOrigin('dca', 'config::ConfigCreatedEvent')
  }::config::ConfigCreatedEvent` as const
  static readonly $numTypeParams = 0
  static readonly $isPhantom = [] as const

  readonly $typeName: typeof ConfigCreatedEvent.$typeName = ConfigCreatedEvent.$typeName
  readonly $fullTypeName: `${string}::config::ConfigCreatedEvent`
  readonly $typeArgs: []
  readonly $isPhantom: typeof ConfigCreatedEvent.$isPhantom = ConfigCreatedEvent.$isPhantom
  ...
  static reified(): ConfigCreatedEventReified {
    ...
    return {
      ...
      reifiedTypeArgs: [],
      fromFields: (fields: Record<string, any>) => ConfigCreatedEvent.fromFields(fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) => ConfigCreatedEvent.fromFieldsWithTypes(item),
      fromBcs: (data: Uint8Array) => ConfigCreatedEvent.fromFields(reifiedBcs.parse(data)),
      bcs: reifiedBcs,
      fromJSONField: (field: any) => ConfigCreatedEvent.fromJSONField(field),
      fromJSON: (json: Record<string, any>) => ConfigCreatedEvent.fromJSON(json),
      fromSuiParsedData: (content: SuiParsedData) => ConfigCreatedEvent.fromSuiParsedData(content),
      fromSuiObjectData: (content: SuiObjectData) => ConfigCreatedEvent.fromSuiObjectData(content),
      fetch: async (client: SupportedSuiClient, id: string) => ConfigCreatedEvent.fetch(client, id),
  ...
  private static cachedBcs: ReturnType<typeof ConfigCreatedEvent.instantiateBcs> | null = null
  ...
  static fromFieldsWithTypes(item: FieldsWithTypes): ConfigCreatedEvent {
    ...
    return ConfigCreatedEvent.reified().new({
      ...
      feeTrackerId: decodeFromFieldsWithTypes(ID.reified(), item.fields.fee_tracker_id),
  ...
  static fromSuiParsedData(content: SuiParsedData): ConfigCreatedEvent {
    ...
    if (!isConfigCreatedEvent(content.type)) {
      throw new Error(`object at ${(content.fields as any).id} is not a ConfigCreatedEvent object`)
    }
  ...
  static fromSuiObjectData(data: SuiObjectData): ConfigCreatedEvent {
    if (data.bcs) {
      if (data.bcs.dataType !== 'moveObject' || !isConfigCreatedEvent(data.bcs.type)) {
  ...
  static async fetch(client: SupportedSuiClient, id: string): Promise<ConfigCreatedEvent> {
    const res = await fetchObjectBcs(client, id)
...
export type ConfigUpdatedEventReified = Reified<ConfigUpdatedEvent, ConfigUpdatedEventFields>
...
export class ConfigUpdatedEvent implements StructClass {
  ...
  static readonly $typeName: `${string}::config::ConfigUpdatedEvent` = `${
    getTypeOrigin('dca', 'config::ConfigUpdatedEvent')
  }::config::ConfigUpdatedEvent` as const
  static readonly $numTypeParams = 0
  static readonly $isPhantom = [] as const

  readonly $typeName: typeof ConfigUpdatedEvent.$typeName = ConfigUpdatedEvent.$typeName
  readonly $fullTypeName: `${string}::config::ConfigUpdatedEvent`
  readonly $typeArgs: []
  readonly $isPhantom: typeof ConfigUpdatedEvent.$isPhantom = ConfigUpdatedEvent.$isPhantom
  ...
  static reified(): ConfigUpdatedEventReified {
    ...
    return {
      ...
      reifiedTypeArgs: [],
      fromFields: (fields: Record<string, any>) => ConfigUpdatedEvent.fromFields(fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) => ConfigUpdatedEvent.fromFieldsWithTypes(item),
      fromBcs: (data: Uint8Array) => ConfigUpdatedEvent.fromFields(reifiedBcs.parse(data)),
      bcs: reifiedBcs,
      fromJSONField: (field: any) => ConfigUpdatedEvent.fromJSONField(field),
      fromJSON: (json: Record<string, any>) => ConfigUpdatedEvent.fromJSON(json),
      fromSuiParsedData: (content: SuiParsedData) => ConfigUpdatedEvent.fromSuiParsedData(content),
      fromSuiObjectData: (content: SuiObjectData) => ConfigUpdatedEvent.fromSuiObjectData(content),
      fetch: async (client: SupportedSuiClient, id: string) => ConfigUpdatedEvent.fetch(client, id),
  ...
  private static cachedBcs: ReturnType<typeof ConfigUpdatedEvent.instantiateBcs> | null = null
  ...
  static fromSuiParsedData(content: SuiParsedData): ConfigUpdatedEvent {
    ...
    if (!isConfigUpdatedEvent(content.type)) {
      throw new Error(`object at ${(content.fields as any).id} is not a ConfigUpdatedEvent object`)
    }
  ...
  static fromSuiObjectData(data: SuiObjectData): ConfigUpdatedEvent {
    if (data.bcs) {
      if (data.bcs.dataType !== 'moveObject' || !isConfigUpdatedEvent(data.bcs.type)) {
  ...
  static async fetch(client: SupportedSuiClient, id: string): Promise<ConfigUpdatedEvent> {
    const res = await fetchObjectBcs(client, id)
...
export type TreasuryUpdatedEventReified = Reified<TreasuryUpdatedEvent, TreasuryUpdatedEventFields>
...
export class TreasuryUpdatedEvent implements StructClass {
  ...
  static readonly $typeName: `${string}::config::TreasuryUpdatedEvent` = `${
    getTypeOrigin('dca', 'config::TreasuryUpdatedEvent')
  }::config::TreasuryUpdatedEvent` as const
  static readonly $numTypeParams = 0
  static readonly $isPhantom = [] as const

  readonly $typeName: typeof TreasuryUpdatedEvent.$typeName = TreasuryUpdatedEvent.$typeName
  readonly $fullTypeName: `${string}::config::TreasuryUpdatedEvent`
  readonly $typeArgs: []
  readonly $isPhantom: typeof TreasuryUpdatedEvent.$isPhantom = TreasuryUpdatedEvent.$isPhantom
  ...
  static reified(): TreasuryUpdatedEventReified {
    ...
    return {
      ...
      reifiedTypeArgs: [],
      fromFields: (fields: Record<string, any>) => TreasuryUpdatedEvent.fromFields(fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        TreasuryUpdatedEvent.fromFieldsWithTypes(item),
      fromBcs: (data: Uint8Array) => TreasuryUpdatedEvent.fromFields(reifiedBcs.parse(data)),
      bcs: reifiedBcs,
      fromJSONField: (field: any) => TreasuryUpdatedEvent.fromJSONField(field),
      fromJSON: (json: Record<string, any>) => TreasuryUpdatedEvent.fromJSON(json),
  ...
  private static cachedBcs: ReturnType<typeof TreasuryUpdatedEvent.instantiateBcs> | null = null
  ...
  static fromFieldsWithTypes(item: FieldsWithTypes): TreasuryUpdatedEvent {
    ...
    return TreasuryUpdatedEvent.reified().new({
      configId: decodeFromFieldsWithTypes(ID.reified(), item.fields.config_id),
      oldTreasury: decodeFromFieldsWithTypes('address', item.fields.old_treasury),
      newTreasury: decodeFromFieldsWithTypes('address', item.fields.new_treasury),
    })
  }

  static fromBcs(data: Uint8Array): TreasuryUpdatedEvent {
    return TreasuryUpdatedEvent.fromFields(TreasuryUpdatedEvent.bcs.parse(data))
  }
  ...
  static fromSuiObjectData(data: SuiObjectData): TreasuryUpdatedEvent {
    if (data.bcs) {
      if (data.bcs.dataType !== 'moveObject' || !isTreasuryUpdatedEvent(data.bcs.type)) {
  ...
  static async fetch(client: SupportedSuiClient, id: string): Promise<TreasuryUpdatedEvent> {
    const res = await fetchObjectBcs(client, id)
    if (!isTreasuryUpdatedEvent(res.type)) {
      throw new Error(`object at id ${id} is not a TreasuryUpdatedEvent object`)
    }
...
export type ProtocolPausedEventReified = Reified<ProtocolPausedEvent, ProtocolPausedEventFields>
...
export class ProtocolPausedEvent implements StructClass {
  ...
  static readonly $typeName: `${string}::config::ProtocolPausedEvent` = `${
    getTypeOrigin('dca', 'config::ProtocolPausedEvent')
  }::config::ProtocolPausedEvent` as const
  static readonly $numTypeParams = 0
  static readonly $isPhantom = [] as const

  readonly $typeName: typeof ProtocolPausedEvent.$typeName = ProtocolPausedEvent.$typeName
  readonly $fullTypeName: `${string}::config::ProtocolPausedEvent`
  readonly $typeArgs: []
  readonly $isPhantom: typeof ProtocolPausedEvent.$isPhantom = ProtocolPausedEvent.$isPhantom
  ...
  static reified(): ProtocolPausedEventReified {
    ...
    return {
      ...
      reifiedTypeArgs: [],
      fromFields: (fields: Record<string, any>) => ProtocolPausedEvent.fromFields(fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) => ProtocolPausedEvent.fromFieldsWithTypes(item),
      fromBcs: (data: Uint8Array) => ProtocolPausedEvent.fromFields(reifiedBcs.parse(data)),
      bcs: reifiedBcs,
      fromJSONField: (field: any) => ProtocolPausedEvent.fromJSONField(field),
      fromJSON: (json: Record<string, any>) => ProtocolPausedEvent.fromJSON(json),
      fromSuiParsedData: (content: SuiParsedData) => ProtocolPausedEvent.fromSuiParsedData(content),
      fromSuiObjectData: (content: SuiObjectData) => ProtocolPausedEvent.fromSuiObjectData(content),
      fetch: async (client: SupportedSuiClient, id: string) =>
  ...
  private static cachedBcs: ReturnType<typeof ProtocolPausedEvent.instantiateBcs> | null = null
  ...
  static fromSuiParsedData(content: SuiParsedData): ProtocolPausedEvent {
    ...
    if (!isProtocolPausedEvent(content.type)) {
      throw new Error(`object at ${(content.fields as any).id} is not a ProtocolPausedEvent object`)
    }
  ...
  static fromSuiObjectData(data: SuiObjectData): ProtocolPausedEvent {
    if (data.bcs) {
      if (data.bcs.dataType !== 'moveObject' || !isProtocolPausedEvent(data.bcs.type)) {
  ...
  static async fetch(client: SupportedSuiClient, id: string): Promise<ProtocolPausedEvent> {
    const res = await fetchObjectBcs(client, id)
...
export type FeesWithdrawnEventReified = Reified<FeesWithdrawnEvent, FeesWithdrawnEventFields>
...
export class FeesWithdrawnEvent implements StructClass {
  ...
  static readonly $typeName: `${string}::config::FeesWithdrawnEvent` = `${
    getTypeOrigin('dca', 'config::FeesWithdrawnEvent')
  }::config::FeesWithdrawnEvent` as const
  static readonly $numTypeParams = 0
  static readonly $isPhantom = [] as const

  readonly $typeName: typeof FeesWithdrawnEvent.$typeName = FeesWithdrawnEvent.$typeName
  readonly $fullTypeName: `${string}::config::FeesWithdrawnEvent`
  readonly $typeArgs: []
  readonly $isPhantom: typeof FeesWithdrawnEvent.$isPhantom = FeesWithdrawnEvent.$isPhantom
  ...
  static reified(): FeesWithdrawnEventReified {
    ...
    return {
      ...
      reifiedTypeArgs: [],
      fromFields: (fields: Record<string, any>) => FeesWithdrawnEvent.fromFields(fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) => FeesWithdrawnEvent.fromFieldsWithTypes(item),
      fromBcs: (data: Uint8Array) => FeesWithdrawnEvent.fromFields(reifiedBcs.parse(data)),
      bcs: reifiedBcs,
      fromJSONField: (field: any) => FeesWithdrawnEvent.fromJSONField(field),
      fromJSON: (json: Record<string, any>) => FeesWithdrawnEvent.fromJSON(json),
      fromSuiParsedData: (content: SuiParsedData) => FeesWithdrawnEvent.fromSuiParsedData(content),
      fromSuiObjectData: (content: SuiObjectData) => FeesWithdrawnEvent.fromSuiObjectData(content),
      fetch: async (client: SupportedSuiClient, id: string) => FeesWithdrawnEvent.fetch(client, id),
  ...
  private static cachedBcs: ReturnType<typeof FeesWithdrawnEvent.instantiateBcs> | null = null
  ...
  static fromSuiParsedData(content: SuiParsedData): FeesWithdrawnEvent {
    ...
    if (!isFeesWithdrawnEvent(content.type)) {
      throw new Error(`object at ${(content.fields as any).id} is not a FeesWithdrawnEvent object`)
    }
  ...
  static fromSuiObjectData(data: SuiObjectData): FeesWithdrawnEvent {
    if (data.bcs) {
      if (data.bcs.dataType !== 'moveObject' || !isFeesWithdrawnEvent(data.bcs.type)) {
  ...
  static async fetch(client: SupportedSuiClient, id: string): Promise<FeesWithdrawnEvent> {
    const res = await fetchObjectBcs(client, id)
...
export function isPriceFeedRegistryCreatedEvent(type: string): boolean {
  ...
  return type
    === `${
      getTypeOrigin('dca', 'config::PriceFeedRegistryCreatedEvent')
...
export class PriceFeedRegistryCreatedEvent implements StructClass {
  ...
  private constructor(typeArgs: [], fields: PriceFeedRegistryCreatedEventFields) {
    this.$fullTypeName = composeSuiType(
      PriceFeedRegistryCreatedEvent.$typeName,
      ...typeArgs,
  ...
  static reified(): PriceFeedRegistryCreatedEventReified {
    ...
    return {
      ...
      reifiedTypeArgs: [],
      fromFields: (fields: Record<string, any>) => PriceFeedRegistryCreatedEvent.fromFields(fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        PriceFeedRegistryCreatedEvent.fromFieldsWithTypes(item),
      fromBcs: (data: Uint8Array) =>
        PriceFeedRegistryCreatedEvent.fromFields(reifiedBcs.parse(data)),
      bcs: reifiedBcs,
      fromJSONField: (field: any) => PriceFeedRegistryCreatedEvent.fromJSONField(field),
      fromJSON: (json: Record<string, any>) => PriceFeedRegistryCreatedEvent.fromJSON(json),
      fromSuiParsedData: (content: SuiParsedData) =>
  ...
  private static cachedBcs: ReturnType<typeof PriceFeedRegistryCreatedEvent.instantiateBcs> | null =
    null

  static get bcs(): ReturnType<typeof PriceFeedRegistryCreatedEvent.instantiateBcs> {
    if (!PriceFeedRegistryCreatedEvent.cachedBcs) {
      PriceFeedRegistryCreatedEvent.cachedBcs = PriceFeedRegistryCreatedEvent.instantiateBcs()
    }
    return PriceFeedRegistryCreatedEvent.cachedBcs
  }

  static fromFields(fields: Record<string, any>): PriceFeedRegistryCreatedEvent {
  ...
  static fromFieldsWithTypes(item: FieldsWithTypes): PriceFeedRegistryCreatedEvent {
  ...
  static fromBcs(data: Uint8Array): PriceFeedRegistryCreatedEvent {
    return PriceFeedRegistryCreatedEvent.fromFields(PriceFeedRegistryCreatedEvent.bcs.parse(data))
  }
  ...
  static fromSuiParsedData(content: SuiParsedData): PriceFeedRegistryCreatedEvent {
    if (content.dataType !== 'moveObject') {
      throw new Error('not an object')
    }
  ...
  static fromSuiObjectData(data: SuiObjectData): PriceFeedRegistryCreatedEvent {
    if (data.bcs) {
      if (data.bcs.dataType !== 'moveObject' || !isPriceFeedRegistryCreatedEvent(data.bcs.type)) {
        throw new Error(`object at is not a PriceFeedRegistryCreatedEvent object`)
      }

      return PriceFeedRegistryCreatedEvent.fromBcs(fromBase64(data.bcs.bcsBytes))
    }
    if (data.content) {
  ...
  static async fetch(
    ...
    if (!isPriceFeedRegistryCreatedEvent(res.type)) {
      throw new Error(`object at id ${id} is not a PriceFeedRegistryCreatedEvent object`)
    }
...
export function isPriceFeedRegisteredEvent(type: string): boolean {
  ...
  return type
    === `${
      getTypeOrigin('dca', 'config::PriceFeedRegisteredEvent')
...
export class PriceFeedRegisteredEvent implements StructClass {
  ...
  readonly $typeName: typeof PriceFeedRegisteredEvent.$typeName = PriceFeedRegisteredEvent.$typeName
  ...
  static reified(): PriceFeedRegisteredEventReified {
    ...
    return {
      ...
      reifiedTypeArgs: [],
      fromFields: (fields: Record<string, any>) => PriceFeedRegisteredEvent.fromFields(fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        PriceFeedRegisteredEvent.fromFieldsWithTypes(item),
      fromBcs: (data: Uint8Array) => PriceFeedRegisteredEvent.fromFields(reifiedBcs.parse(data)),
      bcs: reifiedBcs,
      fromJSONField: (field: any) => PriceFeedRegisteredEvent.fromJSONField(field),
      fromJSON: (json: Record<string, any>) => PriceFeedRegisteredEvent.fromJSON(json),
      fromSuiParsedData: (content: SuiParsedData) =>
  ...
  private static cachedBcs: ReturnType<typeof PriceFeedRegisteredEvent.instantiateBcs> | null = null

  static get bcs(): ReturnType<typeof PriceFeedRegisteredEvent.instantiateBcs> {
    if (!PriceFeedRegisteredEvent.cachedBcs) {
      PriceFeedRegisteredEvent.cachedBcs = PriceFeedRegisteredEvent.instantiateBcs()
    }
  ...
  static fromBcs(data: Uint8Array): PriceFeedRegisteredEvent {
    return PriceFeedRegisteredEvent.fromFields(PriceFeedRegisteredEvent.bcs.parse(data))
  }
  ...
  static fromSuiObjectData(data: SuiObjectData): PriceFeedRegisteredEvent {
    if (data.bcs) {
      if (data.bcs.dataType !== 'moveObject' || !isPriceFeedRegisteredEvent(data.bcs.type)) {
  ...
  static async fetch(client: SupportedSuiClient, id: string): Promise<PriceFeedRegisteredEvent> {
    const res = await fetchObjectBcs(client, id)
    if (!isPriceFeedRegisteredEvent(res.type)) {
      throw new Error(`object at id ${id} is not a PriceFeedRegisteredEvent object`)
    }
...
export class PriceFeedRemovedEvent implements StructClass {
  ...
  static readonly $typeName: `${string}::config::PriceFeedRemovedEvent` = `${
    getTypeOrigin('dca', 'config::PriceFeedRemovedEvent')
  }::config::PriceFeedRemovedEvent` as const
  static readonly $numTypeParams = 0
  static readonly $isPhantom = [] as const

  readonly $typeName: typeof PriceFeedRemovedEvent.$typeName = PriceFeedRemovedEvent.$typeName
  readonly $fullTypeName: `${string}::config::PriceFeedRemovedEvent`
  readonly $typeArgs: []
  readonly $isPhantom: typeof PriceFeedRemovedEvent.$isPhantom = PriceFeedRemovedEvent.$isPhantom
  ...
  static reified(): PriceFeedRemovedEventReified {
    ...
    return {
      ...
      reifiedTypeArgs: [],
      fromFields: (fields: Record<string, any>) => PriceFeedRemovedEvent.fromFields(fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        PriceFeedRemovedEvent.fromFieldsWithTypes(item),
      fromBcs: (data: Uint8Array) => PriceFeedRemovedEvent.fromFields(reifiedBcs.parse(data)),
      bcs: reifiedBcs,
      fromJSONField: (field: any) => PriceFeedRemovedEvent.fromJSONField(field),
      fromJSON: (json: Record<string, any>) => PriceFeedRemovedEvent.fromJSON(json),
      fromSuiParsedData: (content: SuiParsedData) =>
  ...
  private static cachedBcs: ReturnType<typeof PriceFeedRemovedEvent.instantiateBcs> | null = null
  ...
  static fromBcs(data: Uint8Array): PriceFeedRemovedEvent {
    return PriceFeedRemovedEvent.fromFields(PriceFeedRemovedEvent.bcs.parse(data))
  }
  ...
  static fromSuiObjectData(data: SuiObjectData): PriceFeedRemovedEvent {
    if (data.bcs) {
      if (data.bcs.dataType !== 'moveObject' || !isPriceFeedRemovedEvent(data.bcs.type)) {
  ...
  static async fetch(client: SupportedSuiClient, id: string): Promise<PriceFeedRemovedEvent> {
    const res = await fetchObjectBcs(client, id)
    if (!isPriceFeedRemovedEvent(res.type)) {
      throw new Error(`object at id ${id} is not a PriceFeedRemovedEvent object`)
    }
...
export function isExecutorWhitelistUpdatedEvent(type: string): boolean {
  ...
  return type
    === `${
      getTypeOrigin('dca', 'config::ExecutorWhitelistUpdatedEvent')
...
export class ExecutorWhitelistUpdatedEvent implements StructClass {
  ...
  private constructor(typeArgs: [], fields: ExecutorWhitelistUpdatedEventFields) {
    this.$fullTypeName = composeSuiType(
      ExecutorWhitelistUpdatedEvent.$typeName,
      ...typeArgs,
  ...
  static reified(): ExecutorWhitelistUpdatedEventReified {
    ...
    return {
      ...
      reifiedTypeArgs: [],
      fromFields: (fields: Record<string, any>) => ExecutorWhitelistUpdatedEvent.fromFields(fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        ExecutorWhitelistUpdatedEvent.fromFieldsWithTypes(item),
      fromBcs: (data: Uint8Array) =>
        ExecutorWhitelistUpdatedEvent.fromFields(reifiedBcs.parse(data)),
      bcs: reifiedBcs,
      fromJSONField: (field: any) => ExecutorWhitelistUpdatedEvent.fromJSONField(field),
      fromJSON: (json: Record<string, any>) => ExecutorWhitelistUpdatedEvent.fromJSON(json),
      fromSuiParsedData: (content: SuiParsedData) =>
  ...
  private static cachedBcs: ReturnType<typeof ExecutorWhitelistUpdatedEvent.instantiateBcs> | null =
    null

  static get bcs(): ReturnType<typeof ExecutorWhitelistUpdatedEvent.instantiateBcs> {
    if (!ExecutorWhitelistUpdatedEvent.cachedBcs) {
      ExecutorWhitelistUpdatedEvent.cachedBcs = ExecutorWhitelistUpdatedEvent.instantiateBcs()
    }
    return ExecutorWhitelistUpdatedEvent.cachedBcs
  }

  static fromFields(fields: Record<string, any>): ExecutorWhitelistUpdatedEvent {
  ...
  static fromFieldsWithTypes(item: FieldsWithTypes): ExecutorWhitelistUpdatedEvent {
  ...
  static fromBcs(data: Uint8Array): ExecutorWhitelistUpdatedEvent {
    return ExecutorWhitelistUpdatedEvent.fromFields(ExecutorWhitelistUpdatedEvent.bcs.parse(data))
  }
  ...
  static fromSuiParsedData(content: SuiParsedData): ExecutorWhitelistUpdatedEvent {
    if (content.dataType !== 'moveObject') {
      throw new Error('not an object')
    }
  ...
  static fromSuiObjectData(data: SuiObjectData): ExecutorWhitelistUpdatedEvent {
    if (data.bcs) {
      if (data.bcs.dataType !== 'moveObject' || !isExecutorWhitelistUpdatedEvent(data.bcs.type)) {
        throw new Error(`object at is not a ExecutorWhitelistUpdatedEvent object`)
      }

      return ExecutorWhitelistUpdatedEvent.fromBcs(fromBase64(data.bcs.bcsBytes))
    }
    if (data.content) {
  ...
  static async fetch(
    ...
    if (!isExecutorWhitelistUpdatedEvent(res.type)) {
      throw new Error(`object at id ${id} is not a ExecutorWhitelistUpdatedEvent object`)
    }
...
export type ExecutorAddedEventReified = Reified<ExecutorAddedEvent, ExecutorAddedEventFields>
...
export class ExecutorAddedEvent implements StructClass {
  ...
  static readonly $typeName: `${string}::config::ExecutorAddedEvent` = `${
    getTypeOrigin('dca', 'config::ExecutorAddedEvent')
  }::config::ExecutorAddedEvent` as const
  static readonly $numTypeParams = 0
  static readonly $isPhantom = [] as const

  readonly $typeName: typeof ExecutorAddedEvent.$typeName = ExecutorAddedEvent.$typeName
  readonly $fullTypeName: `${string}::config::ExecutorAddedEvent`
  readonly $typeArgs: []
  readonly $isPhantom: typeof ExecutorAddedEvent.$isPhantom = ExecutorAddedEvent.$isPhantom
  ...
  static reified(): ExecutorAddedEventReified {
    ...
    return {
      ...
      reifiedTypeArgs: [],
      fromFields: (fields: Record<string, any>) => ExecutorAddedEvent.fromFields(fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) => ExecutorAddedEvent.fromFieldsWithTypes(item),
      fromBcs: (data: Uint8Array) => ExecutorAddedEvent.fromFields(reifiedBcs.parse(data)),
      bcs: reifiedBcs,
      fromJSONField: (field: any) => ExecutorAddedEvent.fromJSONField(field),
      fromJSON: (json: Record<string, any>) => ExecutorAddedEvent.fromJSON(json),
      fromSuiParsedData: (content: SuiParsedData) => ExecutorAddedEvent.fromSuiParsedData(content),
      fromSuiObjectData: (content: SuiObjectData) => ExecutorAddedEvent.fromSuiObjectData(content),
      fetch: async (client: SupportedSuiClient, id: string) => ExecutorAddedEvent.fetch(client, id),
  ...
  private static cachedBcs: ReturnType<typeof ExecutorAddedEvent.instantiateBcs> | null = null
  ...
  static fromSuiParsedData(content: SuiParsedData): ExecutorAddedEvent {
    ...
    if (!isExecutorAddedEvent(content.type)) {
      throw new Error(`object at ${(content.fields as any).id} is not a ExecutorAddedEvent object`)
    }
  ...
  static fromSuiObjectData(data: SuiObjectData): ExecutorAddedEvent {
    if (data.bcs) {
      if (data.bcs.dataType !== 'moveObject' || !isExecutorAddedEvent(data.bcs.type)) {
  ...
  static async fetch(client: SupportedSuiClient, id: string): Promise<ExecutorAddedEvent> {
    const res = await fetchObjectBcs(client, id)
...
export type ExecutorRemovedEventReified = Reified<ExecutorRemovedEvent, ExecutorRemovedEventFields>
...
export class ExecutorRemovedEvent implements StructClass {
  ...
  static readonly $typeName: `${string}::config::ExecutorRemovedEvent` = `${
    getTypeOrigin('dca', 'config::ExecutorRemovedEvent')
  }::config::ExecutorRemovedEvent` as const
  static readonly $numTypeParams = 0
  static readonly $isPhantom = [] as const

  readonly $typeName: typeof ExecutorRemovedEvent.$typeName = ExecutorRemovedEvent.$typeName
  readonly $fullTypeName: `${string}::config::ExecutorRemovedEvent`
  readonly $typeArgs: []
  readonly $isPhantom: typeof ExecutorRemovedEvent.$isPhantom = ExecutorRemovedEvent.$isPhantom
  ...
  static reified(): ExecutorRemovedEventReified {
    ...
    return {
      ...
      reifiedTypeArgs: [],
      fromFields: (fields: Record<string, any>) => ExecutorRemovedEvent.fromFields(fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        ExecutorRemovedEvent.fromFieldsWithTypes(item),
      fromBcs: (data: Uint8Array) => ExecutorRemovedEvent.fromFields(reifiedBcs.parse(data)),
      bcs: reifiedBcs,
      fromJSONField: (field: any) => ExecutorRemovedEvent.fromJSONField(field),
      fromJSON: (json: Record<string, any>) => ExecutorRemovedEvent.fromJSON(json),
      fromSuiParsedData: (content: SuiParsedData) =>
  ...
  private static cachedBcs: ReturnType<typeof ExecutorRemovedEvent.instantiateBcs> | null = null
  ...
  static fromBcs(data: Uint8Array): ExecutorRemovedEvent {
    return ExecutorRemovedEvent.fromFields(ExecutorRemovedEvent.bcs.parse(data))
  }
  ...
  static fromSuiObjectData(data: SuiObjectData): ExecutorRemovedEvent {
    if (data.bcs) {
      if (data.bcs.dataType !== 'moveObject' || !isExecutorRemovedEvent(data.bcs.type)) {
  ...
  static async fetch(client: SupportedSuiClient, id: string): Promise<ExecutorRemovedEvent> {
    const res = await fetchObjectBcs(client, id)
    if (!isExecutorRemovedEvent(res.type)) {
      throw new Error(`object at id ${id} is not a ExecutorRemovedEvent object`)
    }
